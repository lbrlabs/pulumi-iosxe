...
export class StaticRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:index/staticRoute:StaticRoute';
    ...
    public readonly nextHops!: pulumi.Output<outputs.StaticRouteNextHop[] | undefined>;
...
export interface StaticRouteState {
    ...
    nextHops?: pulumi.Input<pulumi.Input<inputs.StaticRouteNextHop>[]>;
