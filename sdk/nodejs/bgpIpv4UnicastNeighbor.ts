...
export class BgpIpv4UnicastNeighbor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:index/bgpIpv4UnicastNeighbor:BgpIpv4UnicastNeighbor';
     ...
     */
    public readonly routeMaps!: pulumi.Output<outputs.BgpIpv4UnicastNeighborRouteMap[] | undefined>;
    /**
...
export interface BgpIpv4UnicastNeighborState {
     ...
     * Apply route map to neighbor
     */
    routeMaps?: pulumi.Input<pulumi.Input<inputs.BgpIpv4UnicastNeighborRouteMap>[]>;
    /**
     * Configure a neighbor as Route Reflector client
     */
