...
export class CryptoIkev2Policy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/cryptoIkev2Policy:CryptoIkev2Policy';
     ...
     * Specify Proposal
     */
    public readonly proposals!: pulumi.Output<outputs.iosxe.CryptoIkev2PolicyProposal[]>;
    ...
    constructor(name: string, argsOrState?: CryptoIkev2PolicyArgs | CryptoIkev2PolicyState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(CryptoIkev2Policy.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface CryptoIkev2PolicyState {
     ...
     * Specify Proposal
     */
    proposals?: pulumi.Input<pulumi.Input<inputs.iosxe.CryptoIkev2PolicyProposal>[]>;
}
