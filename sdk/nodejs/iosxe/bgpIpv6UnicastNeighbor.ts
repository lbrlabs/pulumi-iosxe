...
export class BgpIpv6UnicastNeighbor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/bgpIpv6UnicastNeighbor:BgpIpv6UnicastNeighbor';
     ...
     */
    public readonly routeMaps!: pulumi.Output<outputs.iosxe.BgpIpv6UnicastNeighborRouteMap[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: BgpIpv6UnicastNeighborArgs | BgpIpv6UnicastNeighborState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(BgpIpv6UnicastNeighbor.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface BgpIpv6UnicastNeighborState {
     ...
     * Apply route map to neighbor
     */
    routeMaps?: pulumi.Input<pulumi.Input<inputs.iosxe.BgpIpv6UnicastNeighborRouteMap>[]>;
    /**
     * Configure a neighbor as Route Reflector client
     */
