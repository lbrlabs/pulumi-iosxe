...
export class InterfaceNve extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/interfaceNve:InterfaceNve';
     ...
     */
    public readonly vniVrfs!: pulumi.Output<outputs.iosxe.InterfaceNveVniVrf[] | undefined>;
    /**
     * Configure VNI information
     */
    public readonly vnis!: pulumi.Output<outputs.iosxe.InterfaceNveVni[] | undefined>;
    ...
    constructor(name: string, argsOrState?: InterfaceNveArgs | InterfaceNveState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InterfaceNve.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface InterfaceNveState {
     ...
     * Configure VNI information
     */
    vniVrfs?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceNveVniVrf>[]>;
    /**
     * Configure VNI information
     */
    vnis?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceNveVni>[]>;
}
