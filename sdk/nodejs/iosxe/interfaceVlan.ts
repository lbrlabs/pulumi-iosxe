...
export class InterfaceVlan extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/interfaceVlan:InterfaceVlan';
     ...
     */
    public readonly helperAddresses!: pulumi.Output<outputs.iosxe.InterfaceVlanHelperAddress[] | undefined>;
    ...
    public readonly ipv6Addresses!: pulumi.Output<outputs.iosxe.InterfaceVlanIpv6Address[] | undefined>;
    /**
     * Enable IPv6 on interface
     */
    public readonly ipv6Enable!: pulumi.Output<boolean | undefined>;
    public readonly ipv6LinkLocalAddresses!: pulumi.Output<outputs.iosxe.InterfaceVlanIpv6LinkLocalAddress[] | undefined>;
    /**
...
export interface InterfaceVlanState {
     ...
     * Specify a destination address for UDP broadcasts
     */
    helperAddresses?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceVlanHelperAddress>[]>;
    ...
    ipv6Addresses?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceVlanIpv6Address>[]>;
    /**
     * Enable IPv6 on interface
     */
    ipv6Enable?: pulumi.Input<boolean>;
    ipv6LinkLocalAddresses?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceVlanIpv6LinkLocalAddress>[]>;
    /**
     * Set IPv6 Maximum Transmission Unit - Range: `1280`-`9976`
     */
