...
export class StaticRoute extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/staticRoute:StaticRoute';
    ...
    public readonly nextHops!: pulumi.Output<outputs.iosxe.StaticRouteNextHop[] | undefined>;
...
export interface StaticRouteState {
    ...
    nextHops?: pulumi.Input<pulumi.Input<inputs.iosxe.StaticRouteNextHop>[]>;
