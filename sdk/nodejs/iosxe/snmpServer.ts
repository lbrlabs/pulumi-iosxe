...
export class SnmpServer extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/snmpServer:SnmpServer';
     ...
     */
    public readonly contexts!: pulumi.Output<outputs.iosxe.SnmpServerContext[] | undefined>;
    /**
     ...
     */
    public readonly hosts!: pulumi.Output<outputs.iosxe.SnmpServerHost[] | undefined>;
    /**
     ...
     */
    public readonly snmpCommunities!: pulumi.Output<outputs.iosxe.SnmpServerSnmpCommunity[] | undefined>;
    /**
     ...
     */
    public readonly views!: pulumi.Output<outputs.iosxe.SnmpServerView[] | undefined>;
    ...
    constructor(name: string, argsOrState?: SnmpServerArgs | SnmpServerState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(SnmpServer.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface SnmpServerState {
     ...
     * Create/Delete a context apart from default
     */
    contexts?: pulumi.Input<pulumi.Input<inputs.iosxe.SnmpServerContext>[]>;
    /**
     * Configure behavior when deleting/destroying the resource. Either delete the entire object (YANG container) being
     * managed, or only delete the individual resource attributes configured explicitly and leave everything else as-is.
     * Default value is `all`. - Choices: `all`, `attributes`
     ...
     * Specify hosts keyed by (ip-address, community-or-user)
     */
    hosts?: pulumi.Input<pulumi.Input<inputs.iosxe.SnmpServerHost>[]>;
    /**
     * Persist interface indices
     */
     ...
     * Enable SNMP; set community string and access privs
     */
    snmpCommunities?: pulumi.Input<pulumi.Input<inputs.iosxe.SnmpServerSnmpCommunity>[]>;
    /**
     * Forty GigabitEthernet
     */
     ...
     * Define an SNMPv2 MIB view
     */
    views?: pulumi.Input<pulumi.Input<inputs.iosxe.SnmpServerView>[]>;
}
