...
export class LoggingIpv4HostTransport extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/loggingIpv4HostTransport:LoggingIpv4HostTransport';
     ...
     * Port Number List
     */
    public readonly transportTcpPorts!: pulumi.Output<outputs.iosxe.LoggingIpv4HostTransportTransportTcpPort[] | undefined>;
    /**
     * Port Number List
     */
    public readonly transportTlsPorts!: pulumi.Output<outputs.iosxe.LoggingIpv4HostTransportTransportTlsPort[] | undefined>;
    /**
     * Port Number List
     */
    public readonly transportUdpPorts!: pulumi.Output<outputs.iosxe.LoggingIpv4HostTransportTransportUdpPort[] | undefined>;
    ...
    constructor(name: string, argsOrState?: LoggingIpv4HostTransportArgs | LoggingIpv4HostTransportState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(LoggingIpv4HostTransport.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface LoggingIpv4HostTransportState {
     ...
     * Port Number List
     */
    transportTcpPorts?: pulumi.Input<pulumi.Input<inputs.iosxe.LoggingIpv4HostTransportTransportTcpPort>[]>;
    /**
     * Port Number List
     */
    transportTlsPorts?: pulumi.Input<pulumi.Input<inputs.iosxe.LoggingIpv4HostTransportTransportTlsPort>[]>;
    /**
     * Port Number List
     */
    transportUdpPorts?: pulumi.Input<pulumi.Input<inputs.iosxe.LoggingIpv4HostTransportTransportUdpPort>[]>;
}
