...
export class Arp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/arp:Arp';
     ...
     */
    public readonly inspectionFilters!: pulumi.Output<outputs.iosxe.ArpInspectionFilter[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ArpArgs | ArpState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Arp.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ArpState {
     ...
     * Specify ARP acl to be applied
     */
    inspectionFilters?: pulumi.Input<pulumi.Input<inputs.iosxe.ArpInspectionFilter>[]>;
    /**
     * Number of entries for log buffer - Range: `0`-`1024`
     */
