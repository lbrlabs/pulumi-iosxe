...
export function getTemplate(args: GetTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetTemplateResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getTemplate:getTemplate", {
        "device": args.device,
...
export interface GetTemplateResult {
    ...
    readonly deviceTrackingAttachPolicies: outputs.iosxe.GetTemplateDeviceTrackingAttachPolicy[];
    ...
    readonly id: string;
    readonly ipAccessGroups: outputs.iosxe.GetTemplateIpAccessGroup[];
    ...
    readonly switchportPortSecurityMaximumRanges: outputs.iosxe.GetTemplateSwitchportPortSecurityMaximumRange[];
