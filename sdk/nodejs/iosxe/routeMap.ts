...
export class RouteMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/routeMap:RouteMap';
    ...
    public readonly entries!: pulumi.Output<outputs.iosxe.RouteMapEntry[] | undefined>;
    /**
     * WORD;;Route map tag
     */
...
export interface RouteMapState {
    ...
    entries?: pulumi.Input<pulumi.Input<inputs.iosxe.RouteMapEntry>[]>;
    /**
     * WORD;;Route map tag
     */
