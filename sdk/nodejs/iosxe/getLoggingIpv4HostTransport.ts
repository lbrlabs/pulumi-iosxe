...
export function getLoggingIpv4HostTransport(args: GetLoggingIpv4HostTransportArgs, opts?: pulumi.InvokeOptions): Promise<GetLoggingIpv4HostTransportResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getLoggingIpv4HostTransport:getLoggingIpv4HostTransport", {
        "device": args.device,
...
export interface GetLoggingIpv4HostTransportResult {
    ...
    readonly transportTcpPorts: outputs.iosxe.GetLoggingIpv4HostTransportTransportTcpPort[];
    readonly transportTlsPorts: outputs.iosxe.GetLoggingIpv4HostTransportTransportTlsPort[];
    readonly transportUdpPorts: outputs.iosxe.GetLoggingIpv4HostTransportTransportUdpPort[];
}
