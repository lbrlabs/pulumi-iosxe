...
export class MsdpVrf extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/msdpVrf:MsdpVrf';
     ...
     */
    public readonly passwords!: pulumi.Output<outputs.iosxe.MsdpVrfPassword[] | undefined>;
    /**
     * Configure an MSDP peer
     */
    public readonly peers!: pulumi.Output<outputs.iosxe.MsdpVrfPeer[] | undefined>;
...
export interface MsdpVrfState {
     ...
     * MSDP peer on which the password is to be set
     */
    passwords?: pulumi.Input<pulumi.Input<inputs.iosxe.MsdpVrfPassword>[]>;
    /**
     * Configure an MSDP peer
     */
    peers?: pulumi.Input<pulumi.Input<inputs.iosxe.MsdpVrfPeer>[]>;
