...
export function getPimVrf(args: GetPimVrfArgs, opts?: pulumi.InvokeOptions): Promise<GetPimVrfResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getPimVrf:getPimVrf", {
        "device": args.device,
        "vrf": args.vrf,
    }, opts);
}
...
export interface GetPimVrfResult {
    ...
    readonly rpAddresses: outputs.iosxe.GetPimVrfRpAddress[];
    readonly rpCandidates: outputs.iosxe.GetPimVrfRpCandidate[];
