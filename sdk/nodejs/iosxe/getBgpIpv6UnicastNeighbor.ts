...
export function getBgpIpv6UnicastNeighbor(args: GetBgpIpv6UnicastNeighborArgs, opts?: pulumi.InvokeOptions): Promise<GetBgpIpv6UnicastNeighborResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getBgpIpv6UnicastNeighbor:getBgpIpv6UnicastNeighbor", {
        "asn": args.asn,
        "device": args.device,
        "ip": args.ip,
    }, opts);
...
export interface GetBgpIpv6UnicastNeighborResult {
    ...
    readonly id: string;
    readonly ip: string;
    readonly routeMaps: outputs.iosxe.GetBgpIpv6UnicastNeighborRouteMap[];
