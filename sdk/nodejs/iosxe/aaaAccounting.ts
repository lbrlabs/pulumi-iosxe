...
export class AaaAccounting extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/aaaAccounting:AaaAccounting';
     ...
     */
    public readonly execs!: pulumi.Output<outputs.iosxe.AaaAccountingExec[] | undefined>;
    /**
     * Use Server-group
     */
     ...
     */
    public readonly networks!: pulumi.Output<outputs.iosxe.AaaAccountingNetwork[] | undefined>;
    /**
...
export interface AaaAccountingState {
     ...
     * For starting an exec (shell).
     */
    execs?: pulumi.Input<pulumi.Input<inputs.iosxe.AaaAccountingExec>[]>;
    /**
     * Use Server-group
     */
     ...
     * For network services. (PPP, SLIP, ARAP)
     */
    networks?: pulumi.Input<pulumi.Input<inputs.iosxe.AaaAccountingNetwork>[]>;
    /**
     * Guarantee system accounting as first record.
     */
