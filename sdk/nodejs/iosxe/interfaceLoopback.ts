...
export class InterfaceLoopback extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/interfaceLoopback:InterfaceLoopback';
    ...
    public readonly ipv6Addresses!: pulumi.Output<outputs.iosxe.InterfaceLoopbackIpv6Address[] | undefined>;
    /**
     * Enable IPv6 on interface
     */
    public readonly ipv6Enable!: pulumi.Output<boolean | undefined>;
    public readonly ipv6LinkLocalAddresses!: pulumi.Output<outputs.iosxe.InterfaceLoopbackIpv6LinkLocalAddress[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: InterfaceLoopbackArgs | InterfaceLoopbackState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InterfaceLoopback.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface InterfaceLoopbackState {
    ...
    ipv6Addresses?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceLoopbackIpv6Address>[]>;
    /**
     * Enable IPv6 on interface
     */
    ipv6Enable?: pulumi.Input<boolean>;
    ipv6LinkLocalAddresses?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceLoopbackIpv6LinkLocalAddress>[]>;
    /**
     * Set IPv6 Maximum Transmission Unit - Range: `1280`-`9976`
     */
