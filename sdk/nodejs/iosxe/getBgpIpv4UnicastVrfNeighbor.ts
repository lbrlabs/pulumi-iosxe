...
export function getBgpIpv4UnicastVrfNeighbor(args: GetBgpIpv4UnicastVrfNeighborArgs, opts?: pulumi.InvokeOptions): Promise<GetBgpIpv4UnicastVrfNeighborResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getBgpIpv4UnicastVrfNeighbor:getBgpIpv4UnicastVrfNeighbor", {
        "asn": args.asn,
        "device": args.device,
        "ip": args.ip,
        "vrf": args.vrf,
...
export interface GetBgpIpv4UnicastVrfNeighborResult {
    ...
    readonly routeMaps: outputs.iosxe.GetBgpIpv4UnicastVrfNeighborRouteMap[];
