...
export function getOspfVrf(args: GetOspfVrfArgs, opts?: pulumi.InvokeOptions): Promise<GetOspfVrfResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getOspfVrf:getOspfVrf", {
        "device": args.device,
...
export interface GetOspfVrfResult {
    readonly areas: outputs.iosxe.GetOspfVrfArea[];
    ...
    readonly neighbors: outputs.iosxe.GetOspfVrfNeighbor[];
    readonly networks: outputs.iosxe.GetOspfVrfNetwork[];
    readonly passiveInterfaceDefault: boolean;
    readonly priority: number;
    readonly processId: number;
    readonly routerId: string;
    readonly shutdown: boolean;
    readonly summaryAddresses: outputs.iosxe.GetOspfVrfSummaryAddress[];
    readonly vrf: string;
}
