...
export function getInterfaceTunnel(args: GetInterfaceTunnelArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceTunnelResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getInterfaceTunnel:getInterfaceTunnel", {
        "device": args.device,
        "name": args.name,
    }, opts);
}
...
export interface GetInterfaceTunnelResult {
    ...
    readonly helperAddresses: outputs.iosxe.GetInterfaceTunnelHelperAddress[];
    readonly id: string;
    ...
    readonly ipv6Addresses: outputs.iosxe.GetInterfaceTunnelIpv6Address[];
    readonly ipv6Enable: boolean;
    readonly ipv6LinkLocalAddresses: outputs.iosxe.GetInterfaceTunnelIpv6LinkLocalAddress[];
