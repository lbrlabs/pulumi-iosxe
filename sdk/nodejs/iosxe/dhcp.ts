...
export class Dhcp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/dhcp:Dhcp';
     ...
     * DHCP Snooping vlan
     */
    public readonly snoopingVlans!: pulumi.Output<outputs.iosxe.DhcpSnoopingVlan[] | undefined>;
...
export interface DhcpState {
     ...
     * DHCP Snooping vlan
     */
    snoopingVlans?: pulumi.Input<pulumi.Input<inputs.iosxe.DhcpSnoopingVlan>[]>;
}
