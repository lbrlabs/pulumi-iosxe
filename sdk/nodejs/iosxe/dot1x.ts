...
export class Dot1x extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/dot1x:Dot1x';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.iosxe.Dot1xCredential[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: Dot1xArgs | Dot1xState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(Dot1x.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface Dot1xState {
     ...
     * Configure 802.1X credentials profiles
     */
    credentials?: pulumi.Input<pulumi.Input<inputs.iosxe.Dot1xCredential>[]>;
    /**
     * Block all EAPoL transaction on Critical Authentication
     */
