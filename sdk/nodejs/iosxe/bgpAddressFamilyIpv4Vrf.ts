...
export class BgpAddressFamilyIpv4Vrf extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/bgpAddressFamilyIpv4Vrf:BgpAddressFamilyIpv4Vrf';
    ...
    public readonly vrfs!: pulumi.Output<outputs.iosxe.BgpAddressFamilyIpv4VrfVrf[] | undefined>;
...
export interface BgpAddressFamilyIpv4VrfState {
    ...
    vrfs?: pulumi.Input<pulumi.Input<inputs.iosxe.BgpAddressFamilyIpv4VrfVrf>[]>;
}
