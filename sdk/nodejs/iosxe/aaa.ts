...
export class Aaa extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/aaa:Aaa';
     ...
     */
    public readonly groupServerRadii!: pulumi.Output<outputs.iosxe.AaaGroupServerRadius[] | undefined>;
    /**
     * Tacacs+ server-group definition
     */
    public readonly groupServerTacacspluses!: pulumi.Output<outputs.iosxe.AaaGroupServerTacacsplus[] | undefined>;
    /**
     ...
     */
    public readonly serverRadiusDynamicAuthorClients!: pulumi.Output<outputs.iosxe.AaaServerRadiusDynamicAuthorClient[] | undefined>;
    /**
...
export interface AaaState {
     ...
     * Radius server-group definition
     */
    groupServerRadii?: pulumi.Input<pulumi.Input<inputs.iosxe.AaaGroupServerRadius>[]>;
    /**
     * Tacacs+ server-group definition
     */
    groupServerTacacspluses?: pulumi.Input<pulumi.Input<inputs.iosxe.AaaGroupServerTacacsplus>[]>;
    /**
     * Enable NEW access control commands and functions.(Disables OLD commands.)
     */
     ...
     * Specify a RADIUS client
     */
    serverRadiusDynamicAuthorClients?: pulumi.Input<pulumi.Input<inputs.iosxe.AaaServerRadiusDynamicAuthorClient>[]>;
    /**
     * AAA Session ID - Choices: `common`, `unique`
     */
