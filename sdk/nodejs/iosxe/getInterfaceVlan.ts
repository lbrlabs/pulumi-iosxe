...
export function getInterfaceVlan(args: GetInterfaceVlanArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceVlanResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getInterfaceVlan:getInterfaceVlan", {
        "device": args.device,
        "name": args.name,
    }, opts);
}
...
export interface GetInterfaceVlanResult {
    ...
    readonly helperAddresses: outputs.iosxe.GetInterfaceVlanHelperAddress[];
    readonly id: string;
    ...
    readonly ipv6Addresses: outputs.iosxe.GetInterfaceVlanIpv6Address[];
    readonly ipv6Enable: boolean;
    readonly ipv6LinkLocalAddresses: outputs.iosxe.GetInterfaceVlanIpv6LinkLocalAddress[];
