...
export function getInterfacePortChannel(args: GetInterfacePortChannelArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfacePortChannelResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getInterfacePortChannel:getInterfacePortChannel", {
        "device": args.device,
        "name": args.name,
    }, opts);
}
...
export interface GetInterfacePortChannelResult {
    ...
    readonly helperAddresses: outputs.iosxe.GetInterfacePortChannelHelperAddress[];
    readonly id: string;
    ...
    readonly ipv6Addresses: outputs.iosxe.GetInterfacePortChannelIpv6Address[];
    readonly ipv6Enable: boolean;
    readonly ipv6LinkLocalAddresses: outputs.iosxe.GetInterfacePortChannelIpv6LinkLocalAddress[];
