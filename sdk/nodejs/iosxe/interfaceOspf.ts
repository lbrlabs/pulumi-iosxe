...
export class InterfaceOspf extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/interfaceOspf:InterfaceOspf';
     ...
     */
    public readonly messageDigestKeys!: pulumi.Output<outputs.iosxe.InterfaceOspfMessageDigestKey[] | undefined>;
    /**
    ...
    public readonly processIds!: pulumi.Output<outputs.iosxe.InterfaceOspfProcessId[] | undefined>;
    /**
     * IP hops - Range: `1`-`254`
     */
    ...
    constructor(name: string, argsOrState?: InterfaceOspfArgs | InterfaceOspfState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InterfaceOspf.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface InterfaceOspfState {
     ...
     * Message digest authentication password (key)
     */
    messageDigestKeys?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceOspfMessageDigestKey>[]>;
    /**
     * Ignores the MTU in DBD packets
     */
    ...
    processIds?: pulumi.Input<pulumi.Input<inputs.iosxe.InterfaceOspfProcessId>[]>;
    /**
     * IP hops - Range: `1`-`254`
     */
