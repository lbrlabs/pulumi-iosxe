...
export class Ntp extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/ntp:Ntp';
     ...
     */
    public readonly authenticationKeys!: pulumi.Output<outputs.iosxe.NtpAuthenticationKey[] | undefined>;
    /**
     ...
     */
    public readonly peerVrfs!: pulumi.Output<outputs.iosxe.NtpPeerVrf[] | undefined>;
    public readonly peers!: pulumi.Output<outputs.iosxe.NtpPeer[] | undefined>;
    /**
     * VPN Routing/Forwarding Information
     */
    public readonly serverVrfs!: pulumi.Output<outputs.iosxe.NtpServerVrf[] | undefined>;
    public readonly servers!: pulumi.Output<outputs.iosxe.NtpServer[] | undefined>;
    /**
...
export interface NtpState {
     ...
     * Authentication key for trusted time sources
     */
    authenticationKeys?: pulumi.Input<pulumi.Input<inputs.iosxe.NtpAuthenticationKey>[]>;
    /**
     * Length of hardware clock tick - Range: `0`-`4294967295`
     */
     ...
     * VPN Routing/Forwarding Information
     */
    peerVrfs?: pulumi.Input<pulumi.Input<inputs.iosxe.NtpPeerVrf>[]>;
    peers?: pulumi.Input<pulumi.Input<inputs.iosxe.NtpPeer>[]>;
    /**
     * VPN Routing/Forwarding Information
     */
    serverVrfs?: pulumi.Input<pulumi.Input<inputs.iosxe.NtpServerVrf>[]>;
    servers?: pulumi.Input<pulumi.Input<inputs.iosxe.NtpServer>[]>;
    /**
     * Forty GigabitEthernet
     */
