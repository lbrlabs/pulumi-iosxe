...
export class PolicyMapEvent extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/policyMapEvent:PolicyMapEvent';
     ...
     */
    public readonly classNumbers!: pulumi.Output<outputs.iosxe.PolicyMapEventClassNumber[] | undefined>;
    /**
...
export interface PolicyMapEventState {
     ...
     * class number, 1 for 1st class, 2 for 2nd...
     */
    classNumbers?: pulumi.Input<pulumi.Input<inputs.iosxe.PolicyMapEventClassNumber>[]>;
    /**
     * A device name from the provider configuration.
     */
