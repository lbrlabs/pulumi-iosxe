...
export function getServiceTemplate(args: GetServiceTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetServiceTemplateResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getServiceTemplate:getServiceTemplate", {
        "device": args.device,
        "name": args.name,
    }, opts);
}
...
export interface GetServiceTemplateResult {
    ...
    readonly accessGroups: outputs.iosxe.GetServiceTemplateAccessGroup[];
    ...
    readonly interfaceTemplates: outputs.iosxe.GetServiceTemplateInterfaceTemplate[];
    ...
    readonly sgt: number;
    readonly tags: outputs.iosxe.GetServiceTemplateTag[];
