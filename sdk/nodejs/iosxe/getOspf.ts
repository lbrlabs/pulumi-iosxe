...
export function getOspf(args: GetOspfArgs, opts?: pulumi.InvokeOptions): Promise<GetOspfResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getOspf:getOspf", {
        "device": args.device,
...
export interface GetOspfResult {
    readonly areas: outputs.iosxe.GetOspfArea[];
    ...
    readonly neighbors: outputs.iosxe.GetOspfNeighbor[];
    readonly networks: outputs.iosxe.GetOspfNetwork[];
    readonly passiveInterfaceDefault: boolean;
    readonly priority: number;
    readonly processId: number;
    readonly routerId: string;
    readonly shutdown: boolean;
    readonly summaryAddresses: outputs.iosxe.GetOspfSummaryAddress[];
}
