...
export class Line extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/line:Line';
     ...
     */
    public readonly consoles!: pulumi.Output<outputs.iosxe.LineConsole[] | undefined>;
    /**
     ...
     * Virtual terminal
     */
    public readonly vties!: pulumi.Output<outputs.iosxe.LineVty[] | undefined>;
...
export interface LineState {
     ...
     * Primary terminal line
     */
    consoles?: pulumi.Input<pulumi.Input<inputs.iosxe.LineConsole>[]>;
    /**
     * Configure behavior when deleting/destroying the resource. Either delete the entire object (YANG container) being
     * managed, or only delete the individual resource attributes configured explicitly and leave everything else as-is.
     * Default value is `all`. - Choices: `all`, `attributes`
     ...
     * Virtual terminal
     */
    vties?: pulumi.Input<pulumi.Input<inputs.iosxe.LineVty>[]>;
}
