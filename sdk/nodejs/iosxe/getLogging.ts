...
export function getLogging(args?: GetLoggingArgs, opts?: pulumi.InvokeOptions): Promise<GetLoggingResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getLogging:getLogging", {
        "device": args.device,
    }, opts);
}
...
export interface GetLoggingResult {
    ...
    readonly id: string;
    readonly ipv4Hosts: outputs.iosxe.GetLoggingIpv4Host[];
    readonly ipv4VrfHosts: outputs.iosxe.GetLoggingIpv4VrfHost[];
    readonly ipv6Hosts: outputs.iosxe.GetLoggingIpv6Host[];
    readonly ipv6VrfHosts: outputs.iosxe.GetLoggingIpv6VrfHost[];
    readonly monitorSeverity: string;
    readonly originIdName: string;
    readonly originIdType: string;
    readonly sourceInterface: string;
    readonly sourceInterfacesVrves: outputs.iosxe.GetLoggingSourceInterfacesVrf[];
