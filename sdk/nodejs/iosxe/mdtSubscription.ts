...
export class MdtSubscription extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/mdtSubscription:MdtSubscription';
     ...
     */
    public readonly receivers!: pulumi.Output<outputs.iosxe.MdtSubscriptionReceiver[] | undefined>;
    /**
...
export interface MdtSubscriptionState {
     ...
     * Configuration of receivers of configured subscriptions. Use of this is deprecated. Use mdt-receiver-names instead.
     */
    receivers?: pulumi.Input<pulumi.Input<inputs.iosxe.MdtSubscriptionReceiver>[]>;
    /**
     * The source address for the notifications
     */
