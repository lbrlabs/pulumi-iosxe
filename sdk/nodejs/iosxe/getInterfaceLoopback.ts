...
export function getInterfaceLoopback(args: GetInterfaceLoopbackArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfaceLoopbackResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getInterfaceLoopback:getInterfaceLoopback", {
        "device": args.device,
        "name": args.name,
    }, opts);
}
...
export interface GetInterfaceLoopbackResult {
    ...
    readonly ipv6Addresses: outputs.iosxe.GetInterfaceLoopbackIpv6Address[];
    readonly ipv6Enable: boolean;
    readonly ipv6LinkLocalAddresses: outputs.iosxe.GetInterfaceLoopbackIpv6LinkLocalAddress[];
