...
export function getBgpAddressFamilyIpv4Vrf(args: GetBgpAddressFamilyIpv4VrfArgs, opts?: pulumi.InvokeOptions): Promise<GetBgpAddressFamilyIpv4VrfResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getBgpAddressFamilyIpv4Vrf:getBgpAddressFamilyIpv4Vrf", {
        "afName": args.afName,
        "asn": args.asn,
        "device": args.device,
    }, opts);
...
export interface GetBgpAddressFamilyIpv4VrfResult {
    ...
    readonly id: string;
    readonly vrfs: outputs.iosxe.GetBgpAddressFamilyIpv4VrfVrf[];
}
