...
export function getPim(args?: GetPimArgs, opts?: pulumi.InvokeOptions): Promise<GetPimResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getPim:getPim", {
        "device": args.device,
    }, opts);
}
...
export interface GetPimResult {
    ...
    readonly rpAddresses: outputs.iosxe.GetPimRpAddress[];
    readonly rpCandidates: outputs.iosxe.GetPimRpCandidate[];
