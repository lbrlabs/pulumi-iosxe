...
export function getInterfacePortChannelSubinterface(args: GetInterfacePortChannelSubinterfaceArgs, opts?: pulumi.InvokeOptions): Promise<GetInterfacePortChannelSubinterfaceResult> {
    ...
    return pulumi.runtime.invoke("iosxe:iosxe/getInterfacePortChannelSubinterface:getInterfacePortChannelSubinterface", {
        "device": args.device,
        "name": args.name,
    }, opts);
}
...
export interface GetInterfacePortChannelSubinterfaceResult {
    ...
    readonly helperAddresses: outputs.iosxe.GetInterfacePortChannelSubinterfaceHelperAddress[];
    readonly id: string;
    ...
    readonly ipv6Addresses: outputs.iosxe.GetInterfacePortChannelSubinterfaceIpv6Address[];
    readonly ipv6Enable: boolean;
    readonly ipv6LinkLocalAddresses: outputs.iosxe.GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress[];
