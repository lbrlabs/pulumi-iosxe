...
export class PrefixList extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/prefixList:PrefixList';
     ...
     */
    public readonly prefixes!: pulumi.Output<outputs.iosxe.PrefixListPrefix[] | undefined>;
...
export interface PrefixListState {
     ...
     * Build prefix-lists with name ans seq.no
     */
    prefixes?: pulumi.Input<pulumi.Input<inputs.iosxe.PrefixListPrefix>[]>;
}
