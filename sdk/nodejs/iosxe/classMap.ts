...
export class ClassMap extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/classMap:ClassMap';
     ...
     */
    public readonly matchActivatedServiceTemplates!: pulumi.Output<outputs.iosxe.ClassMapMatchActivatedServiceTemplate[] | undefined>;
    /**
     * authorized
     */
    ...
    constructor(name: string, argsOrState?: ClassMapArgs | ClassMapState, opts?: pulumi.CustomResourceOptions) {
        ...
        super(ClassMap.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface ClassMapState {
     ...
     * match name of service template activated on session
     */
    matchActivatedServiceTemplates?: pulumi.Input<pulumi.Input<inputs.iosxe.ClassMapMatchActivatedServiceTemplate>[]>;
    /**
     * authorized
     */
