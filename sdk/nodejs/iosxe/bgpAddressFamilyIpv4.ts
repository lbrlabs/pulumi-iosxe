...
export class BgpAddressFamilyIpv4 extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'iosxe:iosxe/bgpAddressFamilyIpv4:BgpAddressFamilyIpv4';
     ...
     */
    public readonly ipv4UnicastNetworks!: pulumi.Output<outputs.iosxe.BgpAddressFamilyIpv4Ipv4UnicastNetwork[] | undefined>;
    /**
     * Specify a network to announce via BGP
     */
    public readonly ipv4UnicastNetworksMasks!: pulumi.Output<outputs.iosxe.BgpAddressFamilyIpv4Ipv4UnicastNetworksMask[] | undefined>;
    /**
     * Connected
     */
...
export interface BgpAddressFamilyIpv4State {
     ...
     * Specify a network to announce via BGP
     */
    ipv4UnicastNetworks?: pulumi.Input<pulumi.Input<inputs.iosxe.BgpAddressFamilyIpv4Ipv4UnicastNetwork>[]>;
    /**
     * Specify a network to announce via BGP
     */
    ipv4UnicastNetworksMasks?: pulumi.Input<pulumi.Input<inputs.iosxe.BgpAddressFamilyIpv4Ipv4UnicastNetworksMask>[]>;
    /**
     * Connected
     */
