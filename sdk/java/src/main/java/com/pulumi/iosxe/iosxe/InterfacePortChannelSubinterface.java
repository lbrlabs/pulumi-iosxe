...
import com.pulumi.iosxe.iosxe.inputs.InterfacePortChannelSubinterfaceState;
import com.pulumi.iosxe.iosxe.outputs.InterfacePortChannelSubinterfaceHelperAddress;
import com.pulumi.iosxe.iosxe.outputs.InterfacePortChannelSubinterfaceIpv6Address;
import com.pulumi.iosxe.iosxe.outputs.InterfacePortChannelSubinterfaceIpv6LinkLocalAddress;
...
public class InterfacePortChannelSubinterface extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="helperAddresses", refs={List.class,InterfacePortChannelSubinterfaceHelperAddress.class}, tree="[0,1]")
    private Output</* @Nullable */ List<InterfacePortChannelSubinterfaceHelperAddress>> helperAddresses;

    /**
     * @return Specify a destination address for UDP broadcasts
     * 
     */
    public Output<Optional<List<InterfacePortChannelSubinterfaceHelperAddress>>> helperAddresses() {
    ...
    @Export(name="ipv6Addresses", refs={List.class,InterfacePortChannelSubinterfaceIpv6Address.class}, tree="[0,1]")
    private Output</* @Nullable */ List<InterfacePortChannelSubinterfaceIpv6Address>> ipv6Addresses;

    public Output<Optional<List<InterfacePortChannelSubinterfaceIpv6Address>>> ipv6Addresses() {
    ...
    @Export(name="ipv6LinkLocalAddresses", refs={List.class,InterfacePortChannelSubinterfaceIpv6LinkLocalAddress.class}, tree="[0,1]")
    private Output</* @Nullable */ List<InterfacePortChannelSubinterfaceIpv6LinkLocalAddress>> ipv6LinkLocalAddresses;

    public Output<Optional<List<InterfacePortChannelSubinterfaceIpv6LinkLocalAddress>>> ipv6LinkLocalAddresses() {
     ...
     */
    public InterfacePortChannelSubinterface(String name) {
        this(name, InterfacePortChannelSubinterfaceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InterfacePortChannelSubinterface(String name, @Nullable InterfacePortChannelSubinterfaceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InterfacePortChannelSubinterface(String name, @Nullable InterfacePortChannelSubinterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("iosxe:iosxe/interfacePortChannelSubinterface:InterfacePortChannelSubinterface", name, args == null ? InterfacePortChannelSubinterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InterfacePortChannelSubinterface(String name, Output<String> id, @Nullable InterfacePortChannelSubinterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("iosxe:iosxe/interfacePortChannelSubinterface:InterfacePortChannelSubinterface", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static InterfacePortChannelSubinterface get(String name, Output<String> id, @Nullable InterfacePortChannelSubinterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
