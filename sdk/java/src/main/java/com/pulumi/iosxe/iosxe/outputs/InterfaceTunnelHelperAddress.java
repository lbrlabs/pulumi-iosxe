...
@CustomType
public final class InterfaceTunnelHelperAddress {
    ...
    public static Builder builder(InterfaceTunnelHelperAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vrf;
        public Builder() {}
        public Builder(InterfaceTunnelHelperAddress defaults) {
        ...
        public InterfaceTunnelHelperAddress build() {
            final var o = new InterfaceTunnelHelperAddress();
            o.address = address;
            o.global = global;
            o.vrf = vrf;
            return o;
