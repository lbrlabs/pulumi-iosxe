...
public final class LineArgs extends com.pulumi.resources.ResourceArgs {

    public static final LineArgs Empty = new LineArgs();
    ...
    public static Builder builder(LineArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(LineArgs defaults) {
            $ = new LineArgs(Objects.requireNonNull(defaults));
        }
