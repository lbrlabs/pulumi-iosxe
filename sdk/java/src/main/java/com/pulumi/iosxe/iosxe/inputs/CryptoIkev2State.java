...
public final class CryptoIkev2State extends com.pulumi.resources.ResourceArgs {

    public static final CryptoIkev2State Empty = new CryptoIkev2State();
    ...
    private CryptoIkev2State() {}

    private CryptoIkev2State(CryptoIkev2State $) {
    ...
    public static Builder builder(CryptoIkev2State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CryptoIkev2State();
        }

        public Builder(CryptoIkev2State defaults) {
            $ = new CryptoIkev2State(Objects.requireNonNull(defaults));
        }
