...
public final class AaaAccountingState extends com.pulumi.resources.ResourceArgs {

    public static final AaaAccountingState Empty = new AaaAccountingState();
    ...
    private AaaAccountingState() {}

    private AaaAccountingState(AaaAccountingState $) {
    ...
    public static Builder builder(AaaAccountingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AaaAccountingState();
        }

        public Builder(AaaAccountingState defaults) {
            $ = new AaaAccountingState(Objects.requireNonNull(defaults));
        }
        ...
        public AaaAccountingState build() {
            return $;
        }
    }
