...
public final class BfdIpv6WithSrcVrfArgs extends com.pulumi.resources.ResourceArgs {

    public static final BfdIpv6WithSrcVrfArgs Empty = new BfdIpv6WithSrcVrfArgs();
    ...
    private BfdIpv6WithSrcVrfArgs() {}

    private BfdIpv6WithSrcVrfArgs(BfdIpv6WithSrcVrfArgs $) {
    ...
    public static Builder builder(BfdIpv6WithSrcVrfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BfdIpv6WithSrcVrfArgs();
        }

        public Builder(BfdIpv6WithSrcVrfArgs defaults) {
            $ = new BfdIpv6WithSrcVrfArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BfdIpv6WithSrcVrfArgs build() {
