...
public final class InterfaceNveState extends com.pulumi.resources.ResourceArgs {

    public static final InterfaceNveState Empty = new InterfaceNveState();
    ...
    private InterfaceNveState() {}

    private InterfaceNveState(InterfaceNveState $) {
    ...
    public static Builder builder(InterfaceNveState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InterfaceNveState();
        }

        public Builder(InterfaceNveState defaults) {
            $ = new InterfaceNveState(Objects.requireNonNull(defaults));
        }
        ...
        public InterfaceNveState build() {
            return $;
        }
    }
