...
@CustomType
public final class LoggingIpv4VrfHost {
    private String ipv4Host;
    private String vrf;

    private LoggingIpv4VrfHost() {}
    ...
    public static Builder builder(LoggingIpv4VrfHost defaults) {
    ...
    public static final class Builder {
        ...
        private String vrf;
        public Builder() {}
        public Builder(LoggingIpv4VrfHost defaults) {
        ...
        public LoggingIpv4VrfHost build() {
            final var o = new LoggingIpv4VrfHost();
            o.ipv4Host = ipv4Host;
            o.vrf = vrf;
            return o;
        }
