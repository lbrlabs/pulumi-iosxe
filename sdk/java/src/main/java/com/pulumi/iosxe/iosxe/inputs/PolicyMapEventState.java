...
public final class PolicyMapEventState extends com.pulumi.resources.ResourceArgs {

    public static final PolicyMapEventState Empty = new PolicyMapEventState();
    ...
    private PolicyMapEventState() {}

    private PolicyMapEventState(PolicyMapEventState $) {
    ...
    public static Builder builder(PolicyMapEventState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PolicyMapEventState();
        }

        public Builder(PolicyMapEventState defaults) {
            $ = new PolicyMapEventState(Objects.requireNonNull(defaults));
        }
        ...
        public PolicyMapEventState build() {
            return $;
        }
    }
