...
public final class BgpNeighborArgs extends com.pulumi.resources.ResourceArgs {

    public static final BgpNeighborArgs Empty = new BgpNeighborArgs();
    ...
    private BgpNeighborArgs() {}

    private BgpNeighborArgs(BgpNeighborArgs $) {
        this.asn = $.asn;
    ...
    public static Builder builder(BgpNeighborArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BgpNeighborArgs defaults) {
            $ = new BgpNeighborArgs(Objects.requireNonNull(defaults));
        }
