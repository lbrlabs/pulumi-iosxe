...
public final class MsdpVrfArgs extends com.pulumi.resources.ResourceArgs {

    public static final MsdpVrfArgs Empty = new MsdpVrfArgs();
    ...
    private MsdpVrfArgs(MsdpVrfArgs $) {
    ...
    public static Builder builder(MsdpVrfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MsdpVrfArgs defaults) {
            $ = new MsdpVrfArgs(Objects.requireNonNull(defaults));
        }
