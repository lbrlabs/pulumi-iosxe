...
public final class MdtSubscriptionArgs extends com.pulumi.resources.ResourceArgs {

    public static final MdtSubscriptionArgs Empty = new MdtSubscriptionArgs();
    ...
    private MdtSubscriptionArgs() {}

    private MdtSubscriptionArgs(MdtSubscriptionArgs $) {
        this.device = $.device;
    ...
    public static Builder builder(MdtSubscriptionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MdtSubscriptionArgs();
        }

        public Builder(MdtSubscriptionArgs defaults) {
            $ = new MdtSubscriptionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MdtSubscriptionArgs build() {
