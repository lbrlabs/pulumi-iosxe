...
public final class GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress {
    ...
    public static Builder builder(GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean linkLocal;
        public Builder() {}
        public Builder(GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress defaults) {
        ...
        public GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress build() {
            final var o = new GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress();
            o.address = address;
