...
public final class CryptoIkev2PolicyState extends com.pulumi.resources.ResourceArgs {

    public static final CryptoIkev2PolicyState Empty = new CryptoIkev2PolicyState();
     ...
     * 
     */
    @Import(name="proposals")
    private @Nullable Output<List<CryptoIkev2PolicyProposalArgs>> proposals;

    /**
     * @return Specify Proposal
     * 
     */
    public Optional<Output<List<CryptoIkev2PolicyProposalArgs>>> proposals() {
        return Optional.ofNullable(this.proposals);
    }

    private CryptoIkev2PolicyState() {}

    private CryptoIkev2PolicyState(CryptoIkev2PolicyState $) {
        this.device = $.device;
    ...
    public static Builder builder(CryptoIkev2PolicyState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CryptoIkev2PolicyState();
        }

        public Builder(CryptoIkev2PolicyState defaults) {
            $ = new CryptoIkev2PolicyState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder proposals(@Nullable Output<List<CryptoIkev2PolicyProposalArgs>> proposals) {
            $.proposals = proposals;
            return this;
        }
        ...
        public CryptoIkev2PolicyState build() {
            return $;
        }
    }
