...
@CustomType
public final class LoggingIpv6VrfHost {
    ...
    public static Builder builder(LoggingIpv6VrfHost defaults) {
    ...
    public static final class Builder {
        ...
        private String vrf;
        public Builder() {}
        public Builder(LoggingIpv6VrfHost defaults) {
        ...
        public LoggingIpv6VrfHost build() {
            final var o = new LoggingIpv6VrfHost();
            o.ipv6Host = ipv6Host;
            o.vrf = vrf;
            return o;
        }
