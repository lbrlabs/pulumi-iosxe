...
import com.pulumi.iosxe.iosxe.outputs.GetBgpIpv4UnicastNeighborRouteMap;
...
public final class GetBgpIpv4UnicastNeighborResult {
    ...
    public static Builder builder(GetBgpIpv4UnicastNeighborResult defaults) {
    ...
    public static final class Builder {
        ...
        private String sendCommunity;
        public Builder() {}
        public Builder(GetBgpIpv4UnicastNeighborResult defaults) {
        ...
        @CustomType.Setter
        public Builder routeMaps(List<GetBgpIpv4UnicastNeighborRouteMap> routeMaps) {
            this.routeMaps = Objects.requireNonNull(routeMaps);
            return this;
        }
        public Builder routeMaps(GetBgpIpv4UnicastNeighborRouteMap... routeMaps) {
        ...
        public GetBgpIpv4UnicastNeighborResult build() {
            final var o = new GetBgpIpv4UnicastNeighborResult();
            o.activate = activate;
            o.asn = asn;
            o.device = device;
            o.id = id;
