...
public final class PimRpAddress {
    ...
    public static Builder builder(PimRpAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rpAddress;
        public Builder() {}
        public Builder(PimRpAddress defaults) {
        ...
        public PimRpAddress build() {
            final var o = new PimRpAddress();
