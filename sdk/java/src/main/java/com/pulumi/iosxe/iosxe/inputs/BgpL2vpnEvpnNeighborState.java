...
public final class BgpL2vpnEvpnNeighborState extends com.pulumi.resources.ResourceArgs {

    public static final BgpL2vpnEvpnNeighborState Empty = new BgpL2vpnEvpnNeighborState();
    ...
    private BgpL2vpnEvpnNeighborState() {}

    private BgpL2vpnEvpnNeighborState(BgpL2vpnEvpnNeighborState $) {
    ...
    public static Builder builder(BgpL2vpnEvpnNeighborState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpL2vpnEvpnNeighborState();
        }

        public Builder(BgpL2vpnEvpnNeighborState defaults) {
            $ = new BgpL2vpnEvpnNeighborState(Objects.requireNonNull(defaults));
        }
        ...
        public BgpL2vpnEvpnNeighborState build() {
            return $;
        }
    }
