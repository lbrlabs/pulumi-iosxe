...
public final class NtpPeerVrfPeerArgs extends com.pulumi.resources.ResourceArgs {

    public static final NtpPeerVrfPeerArgs Empty = new NtpPeerVrfPeerArgs();
    ...
    private NtpPeerVrfPeerArgs() {}

    private NtpPeerVrfPeerArgs(NtpPeerVrfPeerArgs $) {
    ...
    public static Builder builder(NtpPeerVrfPeerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NtpPeerVrfPeerArgs();
        }

        public Builder(NtpPeerVrfPeerArgs defaults) {
            $ = new NtpPeerVrfPeerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public NtpPeerVrfPeerArgs build() {
