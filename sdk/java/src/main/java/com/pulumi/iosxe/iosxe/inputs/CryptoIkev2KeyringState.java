...
public final class CryptoIkev2KeyringState extends com.pulumi.resources.ResourceArgs {

    public static final CryptoIkev2KeyringState Empty = new CryptoIkev2KeyringState();
    ...
    private CryptoIkev2KeyringState() {}

    private CryptoIkev2KeyringState(CryptoIkev2KeyringState $) {
        this.device = $.device;
        this.name = $.name;
        this.peers = $.peers;
    }
    ...
    public static Builder builder(CryptoIkev2KeyringState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CryptoIkev2KeyringState();
        }

        public Builder(CryptoIkev2KeyringState defaults) {
            $ = new CryptoIkev2KeyringState(Objects.requireNonNull(defaults));
        }
        ...
        public CryptoIkev2KeyringState build() {
            return $;
        }
    }
