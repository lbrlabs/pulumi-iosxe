...
public final class NtpServerVrfServer {
    ...
    public static Builder builder(NtpServerVrfServer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer version;
        public Builder() {}
        public Builder(NtpServerVrfServer defaults) {
        ...
        public NtpServerVrfServer build() {
            final var o = new NtpServerVrfServer();
