...
public final class ArpState extends com.pulumi.resources.ResourceArgs {

    public static final ArpState Empty = new ArpState();
    ...
    public static Builder builder(ArpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ArpState defaults) {
            $ = new ArpState(Objects.requireNonNull(defaults));
        }
