...
public final class OspfVrfNetworkArgs extends com.pulumi.resources.ResourceArgs {

    public static final OspfVrfNetworkArgs Empty = new OspfVrfNetworkArgs();
    ...
    private OspfVrfNetworkArgs() {}

    private OspfVrfNetworkArgs(OspfVrfNetworkArgs $) {
        this.area = $.area;
        this.ip = $.ip;
    ...
    public static Builder builder(OspfVrfNetworkArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OspfVrfNetworkArgs();
        }

        public Builder(OspfVrfNetworkArgs defaults) {
            $ = new OspfVrfNetworkArgs(Objects.requireNonNull(defaults));
        }
        ...
        public OspfVrfNetworkArgs build() {
