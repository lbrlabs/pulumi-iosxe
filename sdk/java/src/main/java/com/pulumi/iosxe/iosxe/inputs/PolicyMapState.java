...
public final class PolicyMapState extends com.pulumi.resources.ResourceArgs {

    public static final PolicyMapState Empty = new PolicyMapState();
    ...
    private PolicyMapState() {}

    private PolicyMapState(PolicyMapState $) {
        this.device = $.device;
        this.name = $.name;
    ...
    public static Builder builder(PolicyMapState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PolicyMapState defaults) {
            $ = new PolicyMapState(Objects.requireNonNull(defaults));
        }
