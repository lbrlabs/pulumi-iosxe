...
public final class StaticRouteVrfRouteNextHopArgs extends com.pulumi.resources.ResourceArgs {

    public static final StaticRouteVrfRouteNextHopArgs Empty = new StaticRouteVrfRouteNextHopArgs();
    ...
    private StaticRouteVrfRouteNextHopArgs() {}

    private StaticRouteVrfRouteNextHopArgs(StaticRouteVrfRouteNextHopArgs $) {
        this.global = $.global;
        this.metric = $.metric;
        this.name = $.name;
    ...
    public static Builder builder(StaticRouteVrfRouteNextHopArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StaticRouteVrfRouteNextHopArgs();
        }

        public Builder(StaticRouteVrfRouteNextHopArgs defaults) {
            $ = new StaticRouteVrfRouteNextHopArgs(Objects.requireNonNull(defaults));
        }
        ...
        public StaticRouteVrfRouteNextHopArgs build() {
