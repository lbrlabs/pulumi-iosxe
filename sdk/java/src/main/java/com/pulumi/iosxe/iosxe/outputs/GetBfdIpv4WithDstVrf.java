...
public final class GetBfdIpv4WithDstVrf {
    ...
    public static Builder builder(GetBfdIpv4WithDstVrf defaults) {
    ...
    public static final class Builder {
        ...
        private String templateName;
        public Builder() {}
        public Builder(GetBfdIpv4WithDstVrf defaults) {
        ...
        public GetBfdIpv4WithDstVrf build() {
            final var o = new GetBfdIpv4WithDstVrf();
            o.destIp = destIp;
            o.dstVrf = dstVrf;
            o.srcIp = srcIp;
