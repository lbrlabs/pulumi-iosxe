...
public final class BfdIpv6WithDstVrfArgs extends com.pulumi.resources.ResourceArgs {

    public static final BfdIpv6WithDstVrfArgs Empty = new BfdIpv6WithDstVrfArgs();
    ...
    private BfdIpv6WithDstVrfArgs() {}

    private BfdIpv6WithDstVrfArgs(BfdIpv6WithDstVrfArgs $) {
    ...
    public static Builder builder(BfdIpv6WithDstVrfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BfdIpv6WithDstVrfArgs();
        }

        public Builder(BfdIpv6WithDstVrfArgs defaults) {
            $ = new BfdIpv6WithDstVrfArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BfdIpv6WithDstVrfArgs build() {
