...
public final class BfdState extends com.pulumi.resources.ResourceArgs {

    public static final BfdState Empty = new BfdState();
    ...
    public static Builder builder(BfdState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BfdState defaults) {
            $ = new BfdState(Objects.requireNonNull(defaults));
        }
