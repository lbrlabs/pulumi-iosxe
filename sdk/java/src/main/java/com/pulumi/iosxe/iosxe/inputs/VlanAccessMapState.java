...
public final class VlanAccessMapState extends com.pulumi.resources.ResourceArgs {

    public static final VlanAccessMapState Empty = new VlanAccessMapState();
    ...
    private VlanAccessMapState() {}

    private VlanAccessMapState(VlanAccessMapState $) {
        this.action = $.action;
        this.device = $.device;
    ...
    public static Builder builder(VlanAccessMapState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VlanAccessMapState();
        }

        public Builder(VlanAccessMapState defaults) {
            $ = new VlanAccessMapState(Objects.requireNonNull(defaults));
        }
        ...
        public VlanAccessMapState build() {
            return $;
        }
    }
