...
public final class LoggingIpv6HostTransportState extends com.pulumi.resources.ResourceArgs {

    public static final LoggingIpv6HostTransportState Empty = new LoggingIpv6HostTransportState();
    ...
    private LoggingIpv6HostTransportState() {}

    private LoggingIpv6HostTransportState(LoggingIpv6HostTransportState $) {
    ...
    public static Builder builder(LoggingIpv6HostTransportState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LoggingIpv6HostTransportState();
        }

        public Builder(LoggingIpv6HostTransportState defaults) {
            $ = new LoggingIpv6HostTransportState(Objects.requireNonNull(defaults));
        }
        ...
        public LoggingIpv6HostTransportState build() {
            return $;
        }
    }
