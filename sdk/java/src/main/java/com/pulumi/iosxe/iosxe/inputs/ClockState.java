...
public final class ClockState extends com.pulumi.resources.ResourceArgs {

    public static final ClockState Empty = new ClockState();
    ...
    public static Builder builder(ClockState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClockState defaults) {
            $ = new ClockState(Objects.requireNonNull(defaults));
        }
