...
@CustomType
public final class BgpIpv6UnicastNeighborRouteMap {
    private String inOut;
    private String routeMapName;

    private BgpIpv6UnicastNeighborRouteMap() {}
    public String inOut() {
        return this.inOut;
    }
    ...
    public static Builder builder(BgpIpv6UnicastNeighborRouteMap defaults) {
    ...
    public static final class Builder {
        ...
        private String routeMapName;
        public Builder() {}
        public Builder(BgpIpv6UnicastNeighborRouteMap defaults) {
        ...
        public BgpIpv6UnicastNeighborRouteMap build() {
            final var o = new BgpIpv6UnicastNeighborRouteMap();
            o.inOut = inOut;
