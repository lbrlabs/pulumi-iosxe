...
public final class UdldState extends com.pulumi.resources.ResourceArgs {

    public static final UdldState Empty = new UdldState();
    ...
    public static Builder builder(UdldState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(UdldState defaults) {
            $ = new UdldState(Objects.requireNonNull(defaults));
        }
