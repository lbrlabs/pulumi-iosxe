...
@CustomType
public final class GetBfdIpv6WithoutVrf {
    private String destIpv6;
    private String srcIpv6;
    private String templateName;

    private GetBfdIpv6WithoutVrf() {}
    ...
    public static Builder builder(GetBfdIpv6WithoutVrf defaults) {
    ...
    public static final class Builder {
        ...
        private String templateName;
        public Builder() {}
        public Builder(GetBfdIpv6WithoutVrf defaults) {
        ...
        public GetBfdIpv6WithoutVrf build() {
            final var o = new GetBfdIpv6WithoutVrf();
            o.destIpv6 = destIpv6;
            o.srcIpv6 = srcIpv6;
