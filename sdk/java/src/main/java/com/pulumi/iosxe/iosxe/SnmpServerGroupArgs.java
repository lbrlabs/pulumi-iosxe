...
public final class SnmpServerGroupArgs extends com.pulumi.resources.ResourceArgs {

    public static final SnmpServerGroupArgs Empty = new SnmpServerGroupArgs();
    ...
    private SnmpServerGroupArgs() {}

    private SnmpServerGroupArgs(SnmpServerGroupArgs $) {
        this.device = $.device;
        this.name = $.name;
    ...
    public static Builder builder(SnmpServerGroupArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SnmpServerGroupArgs();
        }

        public Builder(SnmpServerGroupArgs defaults) {
            $ = new SnmpServerGroupArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SnmpServerGroupArgs build() {
            return $;
        }
    }
