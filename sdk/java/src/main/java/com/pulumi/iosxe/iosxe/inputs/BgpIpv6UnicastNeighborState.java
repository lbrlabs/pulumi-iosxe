...
public final class BgpIpv6UnicastNeighborState extends com.pulumi.resources.ResourceArgs {

    public static final BgpIpv6UnicastNeighborState Empty = new BgpIpv6UnicastNeighborState();
    ...
    private @Nullable Output<List<BgpIpv6UnicastNeighborRouteMapArgs>> routeMaps;

    /**
     * @return Apply route map to neighbor
     * 
     */
    public Optional<Output<List<BgpIpv6UnicastNeighborRouteMapArgs>>> routeMaps() {
    ...
    private BgpIpv6UnicastNeighborState() {}

    private BgpIpv6UnicastNeighborState(BgpIpv6UnicastNeighborState $) {
    ...
    public static Builder builder(BgpIpv6UnicastNeighborState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpIpv6UnicastNeighborState();
        }

        public Builder(BgpIpv6UnicastNeighborState defaults) {
            $ = new BgpIpv6UnicastNeighborState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder routeMaps(@Nullable Output<List<BgpIpv6UnicastNeighborRouteMapArgs>> routeMaps) {
            $.routeMaps = routeMaps;
            return this;
        }
         ...
         * 
         */
        public Builder routeMaps(List<BgpIpv6UnicastNeighborRouteMapArgs> routeMaps) {
         ...
         * 
         */
        public Builder routeMaps(BgpIpv6UnicastNeighborRouteMapArgs... routeMaps) {
        ...
        public BgpIpv6UnicastNeighborState build() {
            return $;
        }
    }
