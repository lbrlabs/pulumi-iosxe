...
public final class GetLoggingIpv4HostTransportTransportTcpPort {
    ...
    public static Builder builder(GetLoggingIpv4HostTransportTransportTcpPort defaults) {
    ...
    public static final class Builder {
        private Integer portNumber;
        public Builder() {}
        public Builder(GetLoggingIpv4HostTransportTransportTcpPort defaults) {
        ...
        public GetLoggingIpv4HostTransportTransportTcpPort build() {
            final var o = new GetLoggingIpv4HostTransportTransportTcpPort();
