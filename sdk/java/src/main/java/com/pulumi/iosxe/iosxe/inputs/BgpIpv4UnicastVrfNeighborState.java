...
public final class BgpIpv4UnicastVrfNeighborState extends com.pulumi.resources.ResourceArgs {

    public static final BgpIpv4UnicastVrfNeighborState Empty = new BgpIpv4UnicastVrfNeighborState();
    ...
    private BgpIpv4UnicastVrfNeighborState() {}

    private BgpIpv4UnicastVrfNeighborState(BgpIpv4UnicastVrfNeighborState $) {
    ...
    public static Builder builder(BgpIpv4UnicastVrfNeighborState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BgpIpv4UnicastVrfNeighborState();
        }

        public Builder(BgpIpv4UnicastVrfNeighborState defaults) {
            $ = new BgpIpv4UnicastVrfNeighborState(Objects.requireNonNull(defaults));
        }
        ...
        public BgpIpv4UnicastVrfNeighborState build() {
            return $;
        }
    }
