...
public final class GetNtpServerVrfServer {
    ...
    public static Builder builder(GetNtpServerVrfServer defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetNtpServerVrfServer defaults) {
        ...
        public GetNtpServerVrfServer build() {
            final var o = new GetNtpServerVrfServer();
