...
import com.pulumi.iosxe.iosxe.outputs.GetInterfacePortChannelSubinterfaceHelperAddress;
import com.pulumi.iosxe.iosxe.outputs.GetInterfacePortChannelSubinterfaceIpv6Address;
import com.pulumi.iosxe.iosxe.outputs.GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress;
...
@CustomType
public final class GetInterfacePortChannelSubinterfaceResult {
    /**
     ...
     * 
     */
    private List<GetInterfacePortChannelSubinterfaceHelperAddress> helperAddresses;
    /**
    ...
    private List<GetInterfacePortChannelSubinterfaceIpv6Address> ipv6Addresses;
    /**
     * @return Enable IPv6 on interface
     * 
     */
    private Boolean ipv6Enable;
    private List<GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress> ipv6LinkLocalAddresses;
    /**
     ...
     * 
     */
    public List<GetInterfacePortChannelSubinterfaceHelperAddress> helperAddresses() {
    ...
    public List<GetInterfacePortChannelSubinterfaceIpv6Address> ipv6Addresses() {
    ...
    public List<GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress> ipv6LinkLocalAddresses() {
    ...
    public static Builder builder(GetInterfacePortChannelSubinterfaceResult defaults) {
    ...
    public static final class Builder {
        ...
        private String vrfForwarding;
        public Builder() {}
        public Builder(GetInterfacePortChannelSubinterfaceResult defaults) {
        ...
        @CustomType.Setter
        public Builder helperAddresses(List<GetInterfacePortChannelSubinterfaceHelperAddress> helperAddresses) {
            this.helperAddresses = Objects.requireNonNull(helperAddresses);
            return this;
        }
        public Builder helperAddresses(GetInterfacePortChannelSubinterfaceHelperAddress... helperAddresses) {
        ...
        @CustomType.Setter
        public Builder ipv6Addresses(List<GetInterfacePortChannelSubinterfaceIpv6Address> ipv6Addresses) {
            this.ipv6Addresses = Objects.requireNonNull(ipv6Addresses);
            return this;
        }
        public Builder ipv6Addresses(GetInterfacePortChannelSubinterfaceIpv6Address... ipv6Addresses) {
        ...
        @CustomType.Setter
        public Builder ipv6LinkLocalAddresses(List<GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress> ipv6LinkLocalAddresses) {
            this.ipv6LinkLocalAddresses = Objects.requireNonNull(ipv6LinkLocalAddresses);
            return this;
        }
        public Builder ipv6LinkLocalAddresses(GetInterfacePortChannelSubinterfaceIpv6LinkLocalAddress... ipv6LinkLocalAddresses) {
        ...
        public GetInterfacePortChannelSubinterfaceResult build() {
            final var o = new GetInterfacePortChannelSubinterfaceResult();
