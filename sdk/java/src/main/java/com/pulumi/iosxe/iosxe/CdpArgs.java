...
public final class CdpArgs extends com.pulumi.resources.ResourceArgs {

    public static final CdpArgs Empty = new CdpArgs();
    ...
    public static Builder builder(CdpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CdpArgs defaults) {
            $ = new CdpArgs(Objects.requireNonNull(defaults));
        }
