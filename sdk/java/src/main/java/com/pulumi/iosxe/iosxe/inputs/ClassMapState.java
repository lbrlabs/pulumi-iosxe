...
public final class ClassMapState extends com.pulumi.resources.ResourceArgs {

    public static final ClassMapState Empty = new ClassMapState();
     ...
     * 
     */
    @Import(name="prematch")
    private @Nullable Output<String> prematch;

    /**
     * @return Logical-AND/Logical-OR of all matching statements under this class map - Choices: `match-all`, `match-any`, `match-none`
     * 
     */
    public Optional<Output<String>> prematch() {
        return Optional.ofNullable(this.prematch);
    }
    ...
    private ClassMapState() {}

    private ClassMapState(ClassMapState $) {
    ...
    public static Builder builder(ClassMapState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ClassMapState defaults) {
            $ = new ClassMapState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder prematch(@Nullable Output<String> prematch) {
            $.prematch = prematch;
            return this;
        }
