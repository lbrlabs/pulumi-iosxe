...
public final class MsdpArgs extends com.pulumi.resources.ResourceArgs {

    public static final MsdpArgs Empty = new MsdpArgs();
    ...
    public static Builder builder(MsdpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(MsdpArgs defaults) {
            $ = new MsdpArgs(Objects.requireNonNull(defaults));
        }
