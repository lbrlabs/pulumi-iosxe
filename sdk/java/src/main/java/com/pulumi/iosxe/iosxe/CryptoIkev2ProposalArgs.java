...
public final class CryptoIkev2ProposalArgs extends com.pulumi.resources.ResourceArgs {

    public static final CryptoIkev2ProposalArgs Empty = new CryptoIkev2ProposalArgs();
    ...
    private CryptoIkev2ProposalArgs() {}

    private CryptoIkev2ProposalArgs(CryptoIkev2ProposalArgs $) {
        this.device = $.device;
    ...
    public static Builder builder(CryptoIkev2ProposalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CryptoIkev2ProposalArgs();
        }

        public Builder(CryptoIkev2ProposalArgs defaults) {
            $ = new CryptoIkev2ProposalArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CryptoIkev2ProposalArgs build() {
            return $;
        }
    }
