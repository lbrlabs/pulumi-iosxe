...
import com.pulumi.iosxe.iosxe.inputs.InterfaceTunnelState;
import com.pulumi.iosxe.iosxe.outputs.InterfaceTunnelHelperAddress;
import com.pulumi.iosxe.iosxe.outputs.InterfaceTunnelIpv6Address;
import com.pulumi.iosxe.iosxe.outputs.InterfaceTunnelIpv6LinkLocalAddress;
...
public class InterfaceTunnel extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="cryptoIpsecDfBit", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> cryptoIpsecDfBit;

    /**
     * @return Handling of encapsulated DF bit. - Choices: `clear`, `copy`, `set`
     * 
     */
    public Output<Optional<String>> cryptoIpsecDfBit() {
        return Codegen.optional(this.cryptoIpsecDfBit);
    }
    /**
     ...
     * 
     */
    @Export(name="helperAddresses", refs={List.class,InterfaceTunnelHelperAddress.class}, tree="[0,1]")
    private Output</* @Nullable */ List<InterfaceTunnelHelperAddress>> helperAddresses;

    /**
     * @return Specify a destination address for UDP broadcasts
     * 
     */
    public Output<Optional<List<InterfaceTunnelHelperAddress>>> helperAddresses() {
    ...
    @Export(name="ipv6Addresses", refs={List.class,InterfaceTunnelIpv6Address.class}, tree="[0,1]")
    private Output</* @Nullable */ List<InterfaceTunnelIpv6Address>> ipv6Addresses;

    public Output<Optional<List<InterfaceTunnelIpv6Address>>> ipv6Addresses() {
    ...
    @Export(name="ipv6LinkLocalAddresses", refs={List.class,InterfaceTunnelIpv6LinkLocalAddress.class}, tree="[0,1]")
    private Output</* @Nullable */ List<InterfaceTunnelIpv6LinkLocalAddress>> ipv6LinkLocalAddresses;

    public Output<Optional<List<InterfaceTunnelIpv6LinkLocalAddress>>> ipv6LinkLocalAddresses() {
     ...
     * 
     */
    @Export(name="tunnelDestinationIpv4", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> tunnelDestinationIpv4;

    /**
     * @return ip address or host name
     * 
     */
    public Output<Optional<String>> tunnelDestinationIpv4() {
        return Codegen.optional(this.tunnelDestinationIpv4);
    }
    /**
     * over IPv4
     * 
     */
    @Export(name="tunnelModeIpsecIpv4", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> tunnelModeIpsecIpv4;

    /**
     * @return over IPv4
     * 
     */
    public Output<Optional<Boolean>> tunnelModeIpsecIpv4() {
        return Codegen.optional(this.tunnelModeIpsecIpv4);
    }
    /**
     * Determine the ipsec policy profile to use.
     * 
     */
    @Export(name="tunnelProtectionIpsecProfile", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> tunnelProtectionIpsecProfile;

    /**
     * @return Determine the ipsec policy profile to use.
     * 
     */
    public Output<Optional<String>> tunnelProtectionIpsecProfile() {
        return Codegen.optional(this.tunnelProtectionIpsecProfile);
    }
    /**
     ...
     */
    public InterfaceTunnel(String name) {
        this(name, InterfaceTunnelArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public InterfaceTunnel(String name, @Nullable InterfaceTunnelArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InterfaceTunnel(String name, @Nullable InterfaceTunnelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("iosxe:iosxe/interfaceTunnel:InterfaceTunnel", name, args == null ? InterfaceTunnelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private InterfaceTunnel(String name, Output<String> id, @Nullable InterfaceTunnelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("iosxe:iosxe/interfaceTunnel:InterfaceTunnel", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static InterfaceTunnel get(String name, Output<String> id, @Nullable InterfaceTunnelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
