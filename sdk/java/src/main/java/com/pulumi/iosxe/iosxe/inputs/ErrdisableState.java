...
public final class ErrdisableState extends com.pulumi.resources.ResourceArgs {

    public static final ErrdisableState Empty = new ErrdisableState();
    ...
    private ErrdisableState() {}

    private ErrdisableState(ErrdisableState $) {
    ...
    public static Builder builder(ErrdisableState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ErrdisableState defaults) {
            $ = new ErrdisableState(Objects.requireNonNull(defaults));
        }
