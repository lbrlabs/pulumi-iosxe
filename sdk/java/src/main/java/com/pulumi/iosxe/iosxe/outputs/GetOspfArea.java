...
@CustomType
public final class GetOspfArea {
    /**
     * @return OSPF area ID
     * 
     */
    ...
    public static Builder builder(GetOspfArea defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean nssaNoSummary;
        public Builder() {}
        public Builder(GetOspfArea defaults) {
        ...
        public GetOspfArea build() {
            final var o = new GetOspfArea();
            o.areaId = areaId;
