...
@CustomType
public final class StaticRouteNextHop {
    ...
    public static Builder builder(StaticRouteNextHop defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer tag;
        public Builder() {}
        public Builder(StaticRouteNextHop defaults) {
        ...
        public StaticRouteNextHop build() {
            final var o = new StaticRouteNextHop();
            o.global = global;
            o.metric = metric;
            o.name = name;
            o.nextHop = nextHop;
