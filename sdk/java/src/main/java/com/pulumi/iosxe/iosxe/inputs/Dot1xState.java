...
public final class Dot1xState extends com.pulumi.resources.ResourceArgs {

    public static final Dot1xState Empty = new Dot1xState();
    ...
    public static Builder builder(Dot1xState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(Dot1xState defaults) {
            $ = new Dot1xState(Objects.requireNonNull(defaults));
        }
