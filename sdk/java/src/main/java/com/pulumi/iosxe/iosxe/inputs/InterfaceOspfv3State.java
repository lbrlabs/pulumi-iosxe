...
public final class InterfaceOspfv3State extends com.pulumi.resources.ResourceArgs {

    public static final InterfaceOspfv3State Empty = new InterfaceOspfv3State();
    ...
    private InterfaceOspfv3State() {}

    private InterfaceOspfv3State(InterfaceOspfv3State $) {
        this.cost = $.cost;
    ...
    public static Builder builder(InterfaceOspfv3State defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InterfaceOspfv3State();
        }

        public Builder(InterfaceOspfv3State defaults) {
            $ = new InterfaceOspfv3State(Objects.requireNonNull(defaults));
        }
        ...
        public InterfaceOspfv3State build() {
            return $;
        }
    }
