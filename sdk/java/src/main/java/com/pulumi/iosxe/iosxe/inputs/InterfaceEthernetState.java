...
public final class InterfaceEthernetState extends com.pulumi.resources.ResourceArgs {

    public static final InterfaceEthernetState Empty = new InterfaceEthernetState();
     ...
     * 
     */
    @Import(name="channelGroupMode")
    private @Nullable Output<String> channelGroupMode;

    /**
     * @return Etherchannel Mode of the interface - Choices: `active`, `auto`, `desirable`, `on`, `passive`
     * 
     */
    public Optional<Output<String>> channelGroupMode() {
        return Optional.ofNullable(this.channelGroupMode);
    }
     ...
     * 
     */
    @Import(name="channelGroupNumber")
    private @Nullable Output<Integer> channelGroupNumber;

    /**
     * @return - Range: `1`-`512`
     * 
     */
    public Optional<Output<Integer>> channelGroupNumber() {
        return Optional.ofNullable(this.channelGroupNumber);
    }
    ...
    private @Nullable Output<List<InterfaceEthernetHelperAddressArgs>> helperAddresses;

    /**
     * @return Specify a destination address for UDP broadcasts
     * 
     */
    public Optional<Output<List<InterfaceEthernetHelperAddressArgs>>> helperAddresses() {
    ...
    private @Nullable Output<List<InterfaceEthernetIpv6AddressArgs>> ipv6Addresses;

    public Optional<Output<List<InterfaceEthernetIpv6AddressArgs>>> ipv6Addresses() {
    ...
    private @Nullable Output<List<InterfaceEthernetIpv6LinkLocalAddressArgs>> ipv6LinkLocalAddresses;

    public Optional<Output<List<InterfaceEthernetIpv6LinkLocalAddressArgs>>> ipv6LinkLocalAddresses() {
    ...
    @Import(name="sourceTemplates")
    private @Nullable Output<List<InterfaceEthernetSourceTemplateArgs>> sourceTemplates;

    public Optional<Output<List<InterfaceEthernetSourceTemplateArgs>>> sourceTemplates() {
        return Optional.ofNullable(this.sourceTemplates);
    }
     ...
     * 
     */
    @Import(name="spanningTreeGuard")
    private @Nullable Output<String> spanningTreeGuard;

    /**
     * @return Change an interface&#39;s spanning tree guard mode - Choices: `loop`, `none`, `root`
     * 
     */
    public Optional<Output<String>> spanningTreeGuard() {
        return Optional.ofNullable(this.spanningTreeGuard);
    }
     ...
     * 
     */
    @Import(name="spanningTreeLinkType")
    private @Nullable Output<String> spanningTreeLinkType;

    /**
     * @return Specify a link type for spanning tree tree protocol use - Choices: `point-to-point`, `shared`
     * 
     */
    public Optional<Output<String>> spanningTreeLinkType() {
        return Optional.ofNullable(this.spanningTreeLinkType);
    }
     ...
     * 
     */
    @Import(name="spanningTreePortfastTrunk")
    private @Nullable Output<Boolean> spanningTreePortfastTrunk;

    /**
     * @return Enable portfast on the interface even in trunk mode
     * 
     */
    public Optional<Output<Boolean>> spanningTreePortfastTrunk() {
        return Optional.ofNullable(this.spanningTreePortfastTrunk);
    }

    @Import(name="switchport")
    private @Nullable Output<Boolean> switchport;

    public Optional<Output<Boolean>> switchport() {
    ...
    private InterfaceEthernetState() {}

    private InterfaceEthernetState(InterfaceEthernetState $) {
        ...
        this.channelGroupMode = $.channelGroupMode;
        ...
        this.spanningTreeGuard = $.spanningTreeGuard;
        this.spanningTreeLinkType = $.spanningTreeLinkType;
        this.spanningTreePortfastTrunk = $.spanningTreePortfastTrunk;
    ...
    public static Builder builder(InterfaceEthernetState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InterfaceEthernetState();
        }

        public Builder(InterfaceEthernetState defaults) {
            $ = new InterfaceEthernetState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param channelGroupMode Etherchannel Mode of the interface - Choices: `active`, `auto`, `desirable`, `on`, `passive`
         * 
         * @return builder
         * 
         */
        public Builder channelGroupMode(@Nullable Output<String> channelGroupMode) {
        ...
        public Builder channelGroupMode(String channelGroupMode) {
            return channelGroupMode(Output.of(channelGroupMode));
        }

        /**
         * @param channelGroupNumber - Range: `1`-`512`
         * 
         * @return builder
         * 
         */
        public Builder channelGroupNumber(@Nullable Output<Integer> channelGroupNumber) {
        ...
        public Builder channelGroupNumber(Integer channelGroupNumber) {
            return channelGroupNumber(Output.of(channelGroupNumber));
        }
         ...
         * 
         */
        public Builder helperAddresses(@Nullable Output<List<InterfaceEthernetHelperAddressArgs>> helperAddresses) {
         ...
         * 
         */
        public Builder helperAddresses(List<InterfaceEthernetHelperAddressArgs> helperAddresses) {
         ...
         * 
         */
        public Builder helperAddresses(InterfaceEthernetHelperAddressArgs... helperAddresses) {
        ...
        public Builder ipv6Addresses(@Nullable Output<List<InterfaceEthernetIpv6AddressArgs>> ipv6Addresses) {
            $.ipv6Addresses = ipv6Addresses;
            return this;
        }

        public Builder ipv6Addresses(List<InterfaceEthernetIpv6AddressArgs> ipv6Addresses) {
            return ipv6Addresses(Output.of(ipv6Addresses));
        }

        public Builder ipv6Addresses(InterfaceEthernetIpv6AddressArgs... ipv6Addresses) {
        ...
        public Builder ipv6LinkLocalAddresses(@Nullable Output<List<InterfaceEthernetIpv6LinkLocalAddressArgs>> ipv6LinkLocalAddresses) {
            $.ipv6LinkLocalAddresses = ipv6LinkLocalAddresses;
            return this;
        }

        public Builder ipv6LinkLocalAddresses(List<InterfaceEthernetIpv6LinkLocalAddressArgs> ipv6LinkLocalAddresses) {
            return ipv6LinkLocalAddresses(Output.of(ipv6LinkLocalAddresses));
        }

        public Builder ipv6LinkLocalAddresses(InterfaceEthernetIpv6LinkLocalAddressArgs... ipv6LinkLocalAddresses) {
        ...
        public Builder sourceTemplates(@Nullable Output<List<InterfaceEthernetSourceTemplateArgs>> sourceTemplates) {
            $.sourceTemplates = sourceTemplates;
            return this;
        }

        public Builder sourceTemplates(List<InterfaceEthernetSourceTemplateArgs> sourceTemplates) {
            return sourceTemplates(Output.of(sourceTemplates));
        }

        public Builder sourceTemplates(InterfaceEthernetSourceTemplateArgs... sourceTemplates) {
            return sourceTemplates(List.of(sourceTemplates));
        }

        /**
         * @param spanningTreeGuard Change an interface&#39;s spanning tree guard mode - Choices: `loop`, `none`, `root`
         * 
         * @return builder
         * 
         */
        public Builder spanningTreeGuard(@Nullable Output<String> spanningTreeGuard) {
        ...
        public Builder spanningTreeGuard(String spanningTreeGuard) {
            return spanningTreeGuard(Output.of(spanningTreeGuard));
        }

        /**
         * @param spanningTreeLinkType Specify a link type for spanning tree tree protocol use - Choices: `point-to-point`, `shared`
         * 
         * @return builder
         * 
         */
        public Builder spanningTreeLinkType(@Nullable Output<String> spanningTreeLinkType) {
        ...
        public Builder spanningTreeLinkType(String spanningTreeLinkType) {
            return spanningTreeLinkType(Output.of(spanningTreeLinkType));
        }

        /**
         * @param spanningTreePortfastTrunk Enable portfast on the interface even in trunk mode
         * 
         * @return builder
         * 
         */
        public Builder spanningTreePortfastTrunk(@Nullable Output<Boolean> spanningTreePortfastTrunk) {
        ...
        public Builder spanningTreePortfastTrunk(Boolean spanningTreePortfastTrunk) {
            return spanningTreePortfastTrunk(Output.of(spanningTreePortfastTrunk));
        }

        public Builder switchport(@Nullable Output<Boolean> switchport) {
        ...
        public InterfaceEthernetState build() {
            return $;
        }
    }
