...
public final class CryptoIpsecProfileArgs extends com.pulumi.resources.ResourceArgs {

    public static final CryptoIpsecProfileArgs Empty = new CryptoIpsecProfileArgs();
    ...
    private CryptoIpsecProfileArgs() {}

    private CryptoIpsecProfileArgs(CryptoIpsecProfileArgs $) {
        this.device = $.device;
        this.name = $.name;
    ...
    public static Builder builder(CryptoIpsecProfileArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CryptoIpsecProfileArgs();
        }

        public Builder(CryptoIpsecProfileArgs defaults) {
            $ = new CryptoIpsecProfileArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CryptoIpsecProfileArgs build() {
            return $;
        }
    }
