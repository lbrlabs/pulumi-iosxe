...
public final class SnmpServerState extends com.pulumi.resources.ResourceArgs {

    public static final SnmpServerState Empty = new SnmpServerState();
    ...
    private SnmpServerState() {}

    private SnmpServerState(SnmpServerState $) {
    ...
    public static Builder builder(SnmpServerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(SnmpServerState defaults) {
            $ = new SnmpServerState(Objects.requireNonNull(defaults));
        }
