...
public final class GetInterfaceEthernetHelperAddress {
    ...
    public static Builder builder(GetInterfaceEthernetHelperAddress defaults) {
    ...
    public static final class Builder {
        ...
        private String vrf;
        public Builder() {}
        public Builder(GetInterfaceEthernetHelperAddress defaults) {
        ...
        public GetInterfaceEthernetHelperAddress build() {
            final var o = new GetInterfaceEthernetHelperAddress();
            o.address = address;
            o.global = global;
            o.vrf = vrf;
            return o;
