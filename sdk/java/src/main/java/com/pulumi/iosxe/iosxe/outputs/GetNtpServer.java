...
@CustomType
public final class GetNtpServer {
    ...
    public static Builder builder(GetNtpServer defaults) {
    ...
    public static final class Builder {
        ...
        private Integer version;
        public Builder() {}
        public Builder(GetNtpServer defaults) {
        ...
        public GetNtpServer build() {
            final var o = new GetNtpServer();
