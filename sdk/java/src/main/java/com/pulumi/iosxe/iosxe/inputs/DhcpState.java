...
public final class DhcpState extends com.pulumi.resources.ResourceArgs {

    public static final DhcpState Empty = new DhcpState();
    ...
    public static Builder builder(DhcpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DhcpState defaults) {
            $ = new DhcpState(Objects.requireNonNull(defaults));
        }
