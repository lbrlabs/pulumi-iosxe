...
namespace Lbrlabs.PulumiPackage.Iosxe
{
    ...
    /// ```
    /// </summary>
    [IosxeResourceType("iosxe:index/interfaceTunnel:InterfaceTunnel")]
    public partial class InterfaceTunnel : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("cryptoIpsecDfBit")]
        public Output<string?> CryptoIpsecDfBit { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.InterfaceTunnelHelperAddress>> HelperAddresses { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.InterfaceTunnelIpv6Address>> Ipv6Addresses { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.InterfaceTunnelIpv6LinkLocalAddress>> Ipv6LinkLocalAddresses { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tunnelDestinationIpv4")]
        public Output<string?> TunnelDestinationIpv4 { get; private set; } = null!;

        /// <summary>
        /// over IPv4
        /// </summary>
        [Output("tunnelModeIpsecIpv4")]
        public Output<bool?> TunnelModeIpsecIpv4 { get; private set; } = null!;

        /// <summary>
        /// Determine the ipsec policy profile to use.
        /// </summary>
        [Output("tunnelProtectionIpsecProfile")]
        public Output<string?> TunnelProtectionIpsecProfile { get; private set; } = null!;
        ...
        public InterfaceTunnel(string name, InterfaceTunnelArgs? args = null, CustomResourceOptions? options = null)
            : base("iosxe:index/interfaceTunnel:InterfaceTunnel", name, args ?? new InterfaceTunnelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InterfaceTunnel(string name, Input<string> id, InterfaceTunnelState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:index/interfaceTunnel:InterfaceTunnel", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static InterfaceTunnel Get(string name, Input<string> id, InterfaceTunnelState? state = null, CustomResourceOptions? options = null)
        {
            return new InterfaceTunnel(name, id, state, options);
        }
    }

    public sealed class InterfaceTunnelArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Set ARP cache timeout - Range: `0`-`2147483`
        /// </summary>
        ...
        /// Handling of encapsulated DF bit. - Choices: `clear`, `copy`, `set`
        /// </summary>
        [Input("cryptoIpsecDfBit")]
        public Input<string>? CryptoIpsecDfBit { get; set; }
        ...
        private InputList<Inputs.InterfaceTunnelHelperAddressArgs>? _helperAddresses;

        /// <summary>
        /// Specify a destination address for UDP broadcasts
        /// </summary>
        public InputList<Inputs.InterfaceTunnelHelperAddressArgs> HelperAddresses
        {
            get => _helperAddresses ?? (_helperAddresses = new InputList<Inputs.InterfaceTunnelHelperAddressArgs>());
        ...
        [Input("ipv6Addresses")]
        private InputList<Inputs.InterfaceTunnelIpv6AddressArgs>? _ipv6Addresses;
        public InputList<Inputs.InterfaceTunnelIpv6AddressArgs> Ipv6Addresses
        {
            get => _ipv6Addresses ?? (_ipv6Addresses = new InputList<Inputs.InterfaceTunnelIpv6AddressArgs>());
        ...
        private InputList<Inputs.InterfaceTunnelIpv6LinkLocalAddressArgs>? _ipv6LinkLocalAddresses;
        public InputList<Inputs.InterfaceTunnelIpv6LinkLocalAddressArgs> Ipv6LinkLocalAddresses
        {
            get => _ipv6LinkLocalAddresses ?? (_ipv6LinkLocalAddresses = new InputList<Inputs.InterfaceTunnelIpv6LinkLocalAddressArgs>());
        ...
        /// ip address or host name
        /// </summary>
        [Input("tunnelDestinationIpv4")]
        public Input<string>? TunnelDestinationIpv4 { get; set; }

        /// <summary>
        /// over IPv4
        /// </summary>
        [Input("tunnelModeIpsecIpv4")]
        public Input<bool>? TunnelModeIpsecIpv4 { get; set; }

        /// <summary>
        /// Determine the ipsec policy profile to use.
        /// </summary>
        [Input("tunnelProtectionIpsecProfile")]
        public Input<string>? TunnelProtectionIpsecProfile { get; set; }
        ...
        public InterfaceTunnelArgs()
        {
        }
        public static new InterfaceTunnelArgs Empty => new InterfaceTunnelArgs();
    }

    public sealed class InterfaceTunnelState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Set ARP cache timeout - Range: `0`-`2147483`
        /// </summary>
        ...
        [Input("helperAddresses")]
        private InputList<Inputs.InterfaceTunnelHelperAddressGetArgs>? _helperAddresses;

        /// <summary>
        /// Specify a destination address for UDP broadcasts
        /// </summary>
        public InputList<Inputs.InterfaceTunnelHelperAddressGetArgs> HelperAddresses
        {
            get => _helperAddresses ?? (_helperAddresses = new InputList<Inputs.InterfaceTunnelHelperAddressGetArgs>());
            set => _helperAddresses = value;
        }
        ...
        [Input("ipv6Addresses")]
        private InputList<Inputs.InterfaceTunnelIpv6AddressGetArgs>? _ipv6Addresses;
        public InputList<Inputs.InterfaceTunnelIpv6AddressGetArgs> Ipv6Addresses
        {
            get => _ipv6Addresses ?? (_ipv6Addresses = new InputList<Inputs.InterfaceTunnelIpv6AddressGetArgs>());
            set => _ipv6Addresses = value;
        }
        ...
        [Input("ipv6LinkLocalAddresses")]
        private InputList<Inputs.InterfaceTunnelIpv6LinkLocalAddressGetArgs>? _ipv6LinkLocalAddresses;
        public InputList<Inputs.InterfaceTunnelIpv6LinkLocalAddressGetArgs> Ipv6LinkLocalAddresses
        {
            get => _ipv6LinkLocalAddresses ?? (_ipv6LinkLocalAddresses = new InputList<Inputs.InterfaceTunnelIpv6LinkLocalAddressGetArgs>());
            set => _ipv6LinkLocalAddresses = value;
        }
        ...
        public InterfaceTunnelState()
        {
        }
        public static new InterfaceTunnelState Empty => new InterfaceTunnelState();
    }
}
