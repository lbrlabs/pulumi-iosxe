...
namespace Lbrlabs.PulumiPackage.Iosxe.Iosxe
{
    public static class GetInterfaceTunnel
    {
        public static Task<GetInterfaceTunnelResult> InvokeAsync(GetInterfaceTunnelArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetInterfaceTunnelResult>("iosxe:iosxe/getInterfaceTunnel:getInterfaceTunnel", args ?? new GetInterfaceTunnelArgs(), options.WithDefaults());

        public static Output<GetInterfaceTunnelResult> Invoke(GetInterfaceTunnelInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetInterfaceTunnelResult>("iosxe:iosxe/getInterfaceTunnel:getInterfaceTunnel", args ?? new GetInterfaceTunnelInvokeArgs(), options.WithDefaults());
    }
