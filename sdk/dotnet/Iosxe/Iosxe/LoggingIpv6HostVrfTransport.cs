...
{
    [IosxeResourceType("iosxe:iosxe/loggingIpv6HostVrfTransport:LoggingIpv6HostVrfTransport")]
    public partial class LoggingIpv6HostVrfTransport : global::Pulumi.CustomResource
    {
        ...
        public LoggingIpv6HostVrfTransport(string name, LoggingIpv6HostVrfTransportArgs args, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/loggingIpv6HostVrfTransport:LoggingIpv6HostVrfTransport", name, args ?? new LoggingIpv6HostVrfTransportArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LoggingIpv6HostVrfTransport(string name, Input<string> id, LoggingIpv6HostVrfTransportState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/loggingIpv6HostVrfTransport:LoggingIpv6HostVrfTransport", name, state, MakeResourceOptions(options, id))
        {
        }
