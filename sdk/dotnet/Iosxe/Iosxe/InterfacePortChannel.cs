...
{
    [IosxeResourceType("iosxe:iosxe/interfacePortChannel:InterfacePortChannel")]
    public partial class InterfacePortChannel : global::Pulumi.CustomResource
    {
        ...
        public InterfacePortChannel(string name, InterfacePortChannelArgs? args = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/interfacePortChannel:InterfacePortChannel", name, args ?? new InterfacePortChannelArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InterfacePortChannel(string name, Input<string> id, InterfacePortChannelState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/interfacePortChannel:InterfacePortChannel", name, state, MakeResourceOptions(options, id))
        {
        }
