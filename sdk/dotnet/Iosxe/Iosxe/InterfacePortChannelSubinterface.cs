...
{
    [IosxeResourceType("iosxe:iosxe/interfacePortChannelSubinterface:InterfacePortChannelSubinterface")]
    public partial class InterfacePortChannelSubinterface : global::Pulumi.CustomResource
    {
        ...
        public InterfacePortChannelSubinterface(string name, InterfacePortChannelSubinterfaceArgs? args = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/interfacePortChannelSubinterface:InterfacePortChannelSubinterface", name, args ?? new InterfacePortChannelSubinterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InterfacePortChannelSubinterface(string name, Input<string> id, InterfacePortChannelSubinterfaceState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/interfacePortChannelSubinterface:InterfacePortChannelSubinterface", name, state, MakeResourceOptions(options, id))
        {
        }
