...
{
    [IosxeResourceType("iosxe:iosxe/interfaceVlan:InterfaceVlan")]
    public partial class InterfaceVlan : global::Pulumi.CustomResource
    {
        ...
        public InterfaceVlan(string name, InterfaceVlanArgs? args = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/interfaceVlan:InterfaceVlan", name, args ?? new InterfaceVlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private InterfaceVlan(string name, Input<string> id, InterfaceVlanState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:iosxe/interfaceVlan:InterfaceVlan", name, state, MakeResourceOptions(options, id))
        {
        }
