...
namespace Lbrlabs.PulumiPackage.Iosxe
{
    ...
    /// ```
    /// </summary>
    [IosxeResourceType("iosxe:index/interfaceEthernet:InterfaceEthernet")]
    public partial class InterfaceEthernet : global::Pulumi.CustomResource
    {
        ...
        public InterfaceEthernet(string name, InterfaceEthernetArgs args, CustomResourceOptions? options = null)
            : base("iosxe:index/interfaceEthernet:InterfaceEthernet", name, args ?? new InterfaceEthernetArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private InterfaceEthernet(string name, Input<string> id, InterfaceEthernetState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:index/interfaceEthernet:InterfaceEthernet", name, state, MakeResourceOptions(options, id))
        {
        }
