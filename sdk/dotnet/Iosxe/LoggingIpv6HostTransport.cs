...
namespace Lbrlabs.PulumiPackage.Iosxe
{
    ...
    /// ```
    /// </summary>
    [IosxeResourceType("iosxe:index/loggingIpv6HostTransport:LoggingIpv6HostTransport")]
    public partial class LoggingIpv6HostTransport : global::Pulumi.CustomResource
    {
        ...
        public LoggingIpv6HostTransport(string name, LoggingIpv6HostTransportArgs args, CustomResourceOptions? options = null)
            : base("iosxe:index/loggingIpv6HostTransport:LoggingIpv6HostTransport", name, args ?? new LoggingIpv6HostTransportArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private LoggingIpv6HostTransport(string name, Input<string> id, LoggingIpv6HostTransportState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:index/loggingIpv6HostTransport:LoggingIpv6HostTransport", name, state, MakeResourceOptions(options, id))
        {
        }
