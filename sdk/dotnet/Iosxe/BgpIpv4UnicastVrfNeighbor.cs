...
namespace Lbrlabs.PulumiPackage.Iosxe
{
    ...
    /// ```
    /// </summary>
    [IosxeResourceType("iosxe:index/bgpIpv4UnicastVrfNeighbor:BgpIpv4UnicastVrfNeighbor")]
    public partial class BgpIpv4UnicastVrfNeighbor : global::Pulumi.CustomResource
    {
        ...
        public BgpIpv4UnicastVrfNeighbor(string name, BgpIpv4UnicastVrfNeighborArgs args, CustomResourceOptions? options = null)
            : base("iosxe:index/bgpIpv4UnicastVrfNeighbor:BgpIpv4UnicastVrfNeighbor", name, args ?? new BgpIpv4UnicastVrfNeighborArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private BgpIpv4UnicastVrfNeighbor(string name, Input<string> id, BgpIpv4UnicastVrfNeighborState? state = null, CustomResourceOptions? options = null)
            : base("iosxe:index/bgpIpv4UnicastVrfNeighbor:BgpIpv4UnicastVrfNeighbor", name, state, MakeResourceOptions(options, id))
        {
        }
