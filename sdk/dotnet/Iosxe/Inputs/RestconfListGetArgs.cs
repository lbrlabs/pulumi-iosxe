...
namespace Lbrlabs.PulumiPackage.Iosxe.Inputs
{
    ...
    public sealed class RestconfListGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("items")]
        ...
        public RestconfListGetArgs()
        {
        }
        public static new RestconfListGetArgs Empty => new RestconfListGetArgs();
    }
}
