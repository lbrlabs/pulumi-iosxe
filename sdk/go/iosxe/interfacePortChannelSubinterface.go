...
func NewInterfacePortChannelSubinterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/interfacePortChannelSubinterface:InterfacePortChannelSubinterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfacePortChannelSubinterface(ctx *pulumi.Context,
	...
	var resource InterfacePortChannelSubinterface
	err := ctx.ReadResource("iosxe:index/interfacePortChannelSubinterface:InterfacePortChannelSubinterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
