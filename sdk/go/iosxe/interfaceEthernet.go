...
func NewInterfaceEthernet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/interfaceEthernet:InterfaceEthernet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceEthernet(ctx *pulumi.Context,
	...
	var resource InterfaceEthernet
	err := ctx.ReadResource("iosxe:index/interfaceEthernet:InterfaceEthernet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
