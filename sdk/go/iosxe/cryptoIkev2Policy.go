...
func NewCryptoIkev2Policy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/cryptoIkev2Policy:CryptoIkev2Policy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoIkev2Policy(ctx *pulumi.Context,
	...
	var resource CryptoIkev2Policy
	err := ctx.ReadResource("iosxe:index/cryptoIkev2Policy:CryptoIkev2Policy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
