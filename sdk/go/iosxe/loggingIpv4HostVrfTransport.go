...
func NewLoggingIpv4HostVrfTransport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/loggingIpv4HostVrfTransport:LoggingIpv4HostVrfTransport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingIpv4HostVrfTransport(ctx *pulumi.Context,
	...
	var resource LoggingIpv4HostVrfTransport
	err := ctx.ReadResource("iosxe:index/loggingIpv4HostVrfTransport:LoggingIpv4HostVrfTransport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
