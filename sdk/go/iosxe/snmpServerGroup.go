...
func NewSnmpServerGroup(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/snmpServerGroup:SnmpServerGroup", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnmpServerGroup(ctx *pulumi.Context,
	...
	var resource SnmpServerGroup
	err := ctx.ReadResource("iosxe:index/snmpServerGroup:SnmpServerGroup", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
