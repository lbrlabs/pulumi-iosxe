...
func NewSnmpServerUser(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/snmpServerUser:SnmpServerUser", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnmpServerUser(ctx *pulumi.Context,
	...
	var resource SnmpServerUser
	err := ctx.ReadResource("iosxe:index/snmpServerUser:SnmpServerUser", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
