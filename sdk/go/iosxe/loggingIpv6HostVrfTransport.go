...
func NewLoggingIpv6HostVrfTransport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/loggingIpv6HostVrfTransport:LoggingIpv6HostVrfTransport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingIpv6HostVrfTransport(ctx *pulumi.Context,
	...
	var resource LoggingIpv6HostVrfTransport
	err := ctx.ReadResource("iosxe:index/loggingIpv6HostVrfTransport:LoggingIpv6HostVrfTransport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
