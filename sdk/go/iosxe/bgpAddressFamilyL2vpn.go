...
func NewBgpAddressFamilyL2vpn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/bgpAddressFamilyL2vpn:BgpAddressFamilyL2vpn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpAddressFamilyL2vpn(ctx *pulumi.Context,
	...
	var resource BgpAddressFamilyL2vpn
	err := ctx.ReadResource("iosxe:index/bgpAddressFamilyL2vpn:BgpAddressFamilyL2vpn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
