...
func NewLoggingIpv6HostTransport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/loggingIpv6HostTransport:LoggingIpv6HostTransport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingIpv6HostTransport(ctx *pulumi.Context,
	...
	var resource LoggingIpv6HostTransport
	err := ctx.ReadResource("iosxe:index/loggingIpv6HostTransport:LoggingIpv6HostTransport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
