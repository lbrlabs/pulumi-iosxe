...
func NewOspfVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/ospfVrf:OspfVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspfVrf(ctx *pulumi.Context,
	...
	var resource OspfVrf
	err := ctx.ReadResource("iosxe:index/ospfVrf:OspfVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
