...
func NewInterfaceTunnel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/interfaceTunnel:InterfaceTunnel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceTunnel(ctx *pulumi.Context,
	...
	var resource InterfaceTunnel
	err := ctx.ReadResource("iosxe:index/interfaceTunnel:InterfaceTunnel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
