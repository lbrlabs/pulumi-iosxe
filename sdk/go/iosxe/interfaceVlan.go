...
func NewInterfaceVlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/interfaceVlan:InterfaceVlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceVlan(ctx *pulumi.Context,
	...
	var resource InterfaceVlan
	err := ctx.ReadResource("iosxe:index/interfaceVlan:InterfaceVlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
