...
func NewBgpL2vpnEvpnNeighbor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/bgpL2vpnEvpnNeighbor:BgpL2vpnEvpnNeighbor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpL2vpnEvpnNeighbor(ctx *pulumi.Context,
	...
	var resource BgpL2vpnEvpnNeighbor
	err := ctx.ReadResource("iosxe:index/bgpL2vpnEvpnNeighbor:BgpL2vpnEvpnNeighbor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
