...
func NewInterfacePim(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/interfacePim:InterfacePim", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfacePim(ctx *pulumi.Context,
	...
	var resource InterfacePim
	err := ctx.ReadResource("iosxe:index/interfacePim:InterfacePim", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
