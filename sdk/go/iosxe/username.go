...
func NewUsername(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/username:Username", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetUsername(ctx *pulumi.Context,
	...
	var resource Username
	err := ctx.ReadResource("iosxe:index/username:Username", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
