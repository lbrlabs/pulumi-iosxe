...
func NewInterfaceOspf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/interfaceOspf:InterfaceOspf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceOspf(ctx *pulumi.Context,
	...
	var resource InterfaceOspf
	err := ctx.ReadResource("iosxe:index/interfaceOspf:InterfaceOspf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
