...
func NewStaticRouteVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/staticRouteVrf:StaticRouteVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticRouteVrf(ctx *pulumi.Context,
	...
	var resource StaticRouteVrf
	err := ctx.ReadResource("iosxe:index/staticRouteVrf:StaticRouteVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
