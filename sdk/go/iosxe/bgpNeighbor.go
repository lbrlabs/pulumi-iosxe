...
func NewBgpNeighbor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/bgpNeighbor:BgpNeighbor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpNeighbor(ctx *pulumi.Context,
	...
	var resource BgpNeighbor
	err := ctx.ReadResource("iosxe:index/bgpNeighbor:BgpNeighbor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
