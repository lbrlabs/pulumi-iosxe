...
func NewVlanConfiguration(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/vlanConfiguration:VlanConfiguration", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVlanConfiguration(ctx *pulumi.Context,
	...
	var resource VlanConfiguration
	err := ctx.ReadResource("iosxe:index/vlanConfiguration:VlanConfiguration", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
