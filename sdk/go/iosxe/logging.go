...
func NewLogging(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/logging:Logging", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLogging(ctx *pulumi.Context,
	...
	var resource Logging
	err := ctx.ReadResource("iosxe:index/logging:Logging", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
