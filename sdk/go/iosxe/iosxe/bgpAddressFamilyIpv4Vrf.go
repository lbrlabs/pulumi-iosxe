...
func NewBgpAddressFamilyIpv4Vrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/bgpAddressFamilyIpv4Vrf:BgpAddressFamilyIpv4Vrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpAddressFamilyIpv4Vrf(ctx *pulumi.Context,
	...
	var resource BgpAddressFamilyIpv4Vrf
	err := ctx.ReadResource("iosxe:iosxe/bgpAddressFamilyIpv4Vrf:BgpAddressFamilyIpv4Vrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
