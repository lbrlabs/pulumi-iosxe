...
func NewPolicyMapEvent(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/policyMapEvent:PolicyMapEvent", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyMapEvent(ctx *pulumi.Context,
	...
	var resource PolicyMapEvent
	err := ctx.ReadResource("iosxe:iosxe/policyMapEvent:PolicyMapEvent", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
