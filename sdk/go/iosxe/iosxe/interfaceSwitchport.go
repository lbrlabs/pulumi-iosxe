...
func NewInterfaceSwitchport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/interfaceSwitchport:InterfaceSwitchport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceSwitchport(ctx *pulumi.Context,
	...
	var resource InterfaceSwitchport
	err := ctx.ReadResource("iosxe:iosxe/interfaceSwitchport:InterfaceSwitchport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
