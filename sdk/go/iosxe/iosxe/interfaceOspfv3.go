...
func NewInterfaceOspfv3(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/interfaceOspfv3:InterfaceOspfv3", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceOspfv3(ctx *pulumi.Context,
	...
	var resource InterfaceOspfv3
	err := ctx.ReadResource("iosxe:iosxe/interfaceOspfv3:InterfaceOspfv3", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
