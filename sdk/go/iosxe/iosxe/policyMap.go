...
func NewPolicyMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/policyMap:PolicyMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPolicyMap(ctx *pulumi.Context,
	...
	var resource PolicyMap
	err := ctx.ReadResource("iosxe:iosxe/policyMap:PolicyMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
