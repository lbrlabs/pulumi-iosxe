...
func NewInterfaceLoopback(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/interfaceLoopback:InterfaceLoopback", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceLoopback(ctx *pulumi.Context,
	...
	var resource InterfaceLoopback
	err := ctx.ReadResource("iosxe:iosxe/interfaceLoopback:InterfaceLoopback", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
