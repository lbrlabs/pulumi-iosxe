...
func NewInterfacePortChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/interfacePortChannel:InterfacePortChannel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfacePortChannel(ctx *pulumi.Context,
	...
	var resource InterfacePortChannel
	err := ctx.ReadResource("iosxe:iosxe/interfacePortChannel:InterfacePortChannel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
