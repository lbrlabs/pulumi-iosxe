...
func NewCryptoIpsecTransformSet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/cryptoIpsecTransformSet:CryptoIpsecTransformSet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoIpsecTransformSet(ctx *pulumi.Context,
	...
	var resource CryptoIpsecTransformSet
	err := ctx.ReadResource("iosxe:iosxe/cryptoIpsecTransformSet:CryptoIpsecTransformSet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
