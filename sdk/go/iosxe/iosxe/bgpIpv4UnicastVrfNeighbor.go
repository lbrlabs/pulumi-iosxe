...
func NewBgpIpv4UnicastVrfNeighbor(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/bgpIpv4UnicastVrfNeighbor:BgpIpv4UnicastVrfNeighbor", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpIpv4UnicastVrfNeighbor(ctx *pulumi.Context,
	...
	var resource BgpIpv4UnicastVrfNeighbor
	err := ctx.ReadResource("iosxe:iosxe/bgpIpv4UnicastVrfNeighbor:BgpIpv4UnicastVrfNeighbor", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
