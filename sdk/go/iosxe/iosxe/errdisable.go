...
func NewErrdisable(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/errdisable:Errdisable", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetErrdisable(ctx *pulumi.Context,
	...
	var resource Errdisable
	err := ctx.ReadResource("iosxe:iosxe/errdisable:Errdisable", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
