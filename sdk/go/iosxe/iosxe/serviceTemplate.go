...
func NewServiceTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/serviceTemplate:ServiceTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetServiceTemplate(ctx *pulumi.Context,
	...
	var resource ServiceTemplate
	err := ctx.ReadResource("iosxe:iosxe/serviceTemplate:ServiceTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
