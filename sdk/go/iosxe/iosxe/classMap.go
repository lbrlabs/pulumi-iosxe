...
func NewClassMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/classMap:ClassMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetClassMap(ctx *pulumi.Context,
	...
	var resource ClassMap
	err := ctx.ReadResource("iosxe:iosxe/classMap:ClassMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
