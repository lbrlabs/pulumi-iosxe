...
func NewRouteMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/routeMap:RouteMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMap(ctx *pulumi.Context,
	...
	var resource RouteMap
	err := ctx.ReadResource("iosxe:iosxe/routeMap:RouteMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
