...
func NewAccessListExtended(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/accessListExtended:AccessListExtended", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessListExtended(ctx *pulumi.Context,
	...
	var resource AccessListExtended
	err := ctx.ReadResource("iosxe:iosxe/accessListExtended:AccessListExtended", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
