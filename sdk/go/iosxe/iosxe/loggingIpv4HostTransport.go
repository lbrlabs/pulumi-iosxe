...
func NewLoggingIpv4HostTransport(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/loggingIpv4HostTransport:LoggingIpv4HostTransport", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoggingIpv4HostTransport(ctx *pulumi.Context,
	...
	var resource LoggingIpv4HostTransport
	err := ctx.ReadResource("iosxe:iosxe/loggingIpv4HostTransport:LoggingIpv4HostTransport", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
