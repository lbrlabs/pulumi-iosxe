...
func NewTacacsServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/tacacsServer:TacacsServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetTacacsServer(ctx *pulumi.Context,
	...
	var resource TacacsServer
	err := ctx.ReadResource("iosxe:iosxe/tacacsServer:TacacsServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
