...
func NewInterfaceMpls(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/interfaceMpls:InterfaceMpls", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetInterfaceMpls(ctx *pulumi.Context,
	...
	var resource InterfaceMpls
	err := ctx.ReadResource("iosxe:iosxe/interfaceMpls:InterfaceMpls", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
