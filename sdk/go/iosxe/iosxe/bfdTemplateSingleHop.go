...
func NewBfdTemplateSingleHop(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/bfdTemplateSingleHop:BfdTemplateSingleHop", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBfdTemplateSingleHop(ctx *pulumi.Context,
	...
	var resource BfdTemplateSingleHop
	err := ctx.ReadResource("iosxe:iosxe/bfdTemplateSingleHop:BfdTemplateSingleHop", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
