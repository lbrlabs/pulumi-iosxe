...
func NewPrefixList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/prefixList:PrefixList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPrefixList(ctx *pulumi.Context,
	...
	var resource PrefixList
	err := ctx.ReadResource("iosxe:iosxe/prefixList:PrefixList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
