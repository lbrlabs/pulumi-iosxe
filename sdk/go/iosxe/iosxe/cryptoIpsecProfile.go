...
func NewCryptoIpsecProfile(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/cryptoIpsecProfile:CryptoIpsecProfile", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoIpsecProfile(ctx *pulumi.Context,
	...
	var resource CryptoIpsecProfile
	err := ctx.ReadResource("iosxe:iosxe/cryptoIpsecProfile:CryptoIpsecProfile", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
