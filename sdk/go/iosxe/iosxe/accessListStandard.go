...
func NewAccessListStandard(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/accessListStandard:AccessListStandard", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAccessListStandard(ctx *pulumi.Context,
	...
	var resource AccessListStandard
	err := ctx.ReadResource("iosxe:iosxe/accessListStandard:AccessListStandard", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
