...
func NewStaticRoute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/staticRoute:StaticRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetStaticRoute(ctx *pulumi.Context,
	...
	var resource StaticRoute
	err := ctx.ReadResource("iosxe:iosxe/staticRoute:StaticRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
