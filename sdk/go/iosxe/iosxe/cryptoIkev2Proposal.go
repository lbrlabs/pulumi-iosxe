...
func NewCryptoIkev2Proposal(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/cryptoIkev2Proposal:CryptoIkev2Proposal", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoIkev2Proposal(ctx *pulumi.Context,
	...
	var resource CryptoIkev2Proposal
	err := ctx.ReadResource("iosxe:iosxe/cryptoIkev2Proposal:CryptoIkev2Proposal", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
