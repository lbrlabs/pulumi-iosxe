...
func NewAaaAuthorization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/aaaAuthorization:AaaAuthorization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetAaaAuthorization(ctx *pulumi.Context,
	...
	var resource AaaAuthorization
	err := ctx.ReadResource("iosxe:iosxe/aaaAuthorization:AaaAuthorization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
