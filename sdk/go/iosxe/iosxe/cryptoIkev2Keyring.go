...
func NewCryptoIkev2Keyring(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:iosxe/cryptoIkev2Keyring:CryptoIkev2Keyring", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCryptoIkev2Keyring(ctx *pulumi.Context,
	...
	var resource CryptoIkev2Keyring
	err := ctx.ReadResource("iosxe:iosxe/cryptoIkev2Keyring:CryptoIkev2Keyring", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
