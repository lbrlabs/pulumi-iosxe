...
func NewRestconf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/restconf:Restconf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRestconf(ctx *pulumi.Context,
	...
	var resource Restconf
	err := ctx.ReadResource("iosxe:index/restconf:Restconf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
