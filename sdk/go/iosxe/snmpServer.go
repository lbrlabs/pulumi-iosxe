...
func NewSnmpServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("iosxe:index/snmpServer:SnmpServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSnmpServer(ctx *pulumi.Context,
	...
	var resource SnmpServer
	err := ctx.ReadResource("iosxe:index/snmpServer:SnmpServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
