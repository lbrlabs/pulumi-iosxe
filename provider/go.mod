module github.com/lbrlabs/pulumi-iosxe/provider

go 1.21.1

replace (
	github.com/CiscoDevNet/terraform-provider-iosxe/shim => ./shim
...
require (
	github.com/CiscoDevNet/terraform-provider-iosxe/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/CiscoDevNet/terraform-provider-iosxe v0.5.0 // indirect
	...
	github.com/netascode/go-restconf v0.1.10 // indirect
